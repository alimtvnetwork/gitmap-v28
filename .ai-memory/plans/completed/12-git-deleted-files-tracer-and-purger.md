...
- Render a structured, numbered pre-flight candidate table:
  ...
  ---------------------------------------------------------------------------------------------------------
  [ 1]     .ai-memory/plans/subtasks/01-task.md           2026-09-10    MD ALIM UL KARIM   chore: consolidate...
  [ 2]     .ai-memory/plans/subtasks/02-task.md           2026-09-10    MD ALIM UL KARIM   chore: consolidate...
  [ 3]     02-spec/old-feature/01-spec.md                  2026-08-20    MD ALIM UL KARIM   refactor: remove...
  ```
...
- `[target]`: Positional argument for arbitrary directory or file path from root (e.g. `02-spec/21-app/25-app-spec-audit`, `02-spec/19-main-worker-service/audit`, `.ai-memory`, or `.` for entire repository).
- `--spec-25-audit`: Exact folder shortcut targeting `02-spec/21-app/25-app-spec-audit` (Folder 25 app spec audit documents).
- `--spec-audit`: Exact folder shortcut targeting `02-spec/19-main-worker-service/audit` (audit documents removed after review).
- `--audit`: Repository-wide shortcut targeting all deleted audit files (`*audit*`).
- `--lovable-subtasks`: Scopes tracing to `.ai-memory/plans/subtasks/`.
- `--lovable-audits`: Scopes tracing to `.ai-memory/audits/`.
- `--lovable`: Scopes tracing to all deleted files under `.ai-memory/`.
- `--lovable-md`: Scopes tracing to all deleted `.md` files under `.ai-memory/`.
- `--spec`: Scopes tracing to all deleted files under `02-spec/`.
- `--spec-md`: Scopes tracing to all deleted `.md` files under `02-spec/`.
...
presets:
  --lovable-md          Target all deleted .md files under .ai-memory/
