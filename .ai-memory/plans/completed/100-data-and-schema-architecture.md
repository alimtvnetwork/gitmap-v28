...
## Executive Summary
This master architectural plan establishes repo-wide compliance with authoritative database and data schema conventions defined in `02-spec/04-database-conventions/01-index.md`, `02-spec/04-database-conventions/02-naming-conventions.md`, `02-spec/04-database-conventions/03-schema-design.md`, and `.ai-memory/coding-guidelines.md`.
...
5. **ERD Parity:** Maintain 100% parity between table declarations and `02-spec/21-app/gitmap-database-erd.mmd`.
