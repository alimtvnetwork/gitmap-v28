...
- **Files**: `version.json`, `.ai-memory/memory/release-architecture-map.md`
- **Features**:
  - Document release architecture in `.ai-memory/memory/release-architecture-map.md`.
...
- **Authoritative Specifications Implemented:**
  - [`02-spec/01-app/02-terminal/01-terminal-help.md`](02-spec/01-app/02-terminal/01-terminal-help.md) — Grouped terminal help, dynamic super-categories, and column alignment.
  - [`02-spec/01-app/02-terminal/02-tui-components.md`](02-spec/01-app/02-terminal/02-tui-components.md) — Lipgloss-powered terminal tables, progress bars, and tree views.
  - [`02-spec/01-app/10-macros/01-macro-recorder.md`](02-spec/01-app/10-macros/01-macro-recorder.md) — Command sequence recording and replay engine.
- **Core Architecture Contracts:**
...
- [`.ai-memory/memory/issues/05-duplicate-scroll-containers.md`](.ai-memory/memory/issues/05-duplicate-scroll-containers.md) — CSS overflow fix in React dashboard.
...
- Temp generated scripts MUST go to .ai-memory/temp-scripts/ and remain uncommitted.
...
Subtasks deposited in .ai-memory/plans/subtasks/07-implement-missing-commands/:
...
5. ** 5-release-bump.md**: Commit the changes, execute .ai-memory/temp-scripts/bump.py to bump the minor version in
ersion.json,
...
- [x] [01-help-auditor-and-ledger.md](.ai-memory/plans/subtasks/23-cli-commands-help/01-help-auditor-and-ledger.md) — Create and verify `06-cli-help-auditor.py` to scan all primary commands.
- [x] [02-root-help-formatting.md](.ai-memory/plans/subtasks/23-cli-commands-help/02-root-help-formatting.md) — Compact column formatting (column 30) and 4-space multiline indent in `rootusage.go`.
- [x] [03-subcommand-coverage.md](.ai-memory/plans/subtasks/23-cli-commands-help/03-subcommand-coverage.md) — Verify full subcommand dispatching for SSH, VS Code, AGY, and Cluster.
- [x] [04-verification.md](.ai-memory/plans/subtasks/23-cli-commands-help/04-verification.md) — Run all CLI parity test suites, linters, and quality gates.
...
- [x] [01-terminal-palette-and-banners.md](.ai-memory/plans/subtasks/27-terminal-ui/01-terminal-palette-and-banners.md) — Bright bold ANSI 9X codes and super-category intent banners.
- [x] [02-lipgloss-two-pass-rendering.md](.ai-memory/plans/subtasks/27-terminal-ui/02-lipgloss-two-pass-rendering.md) — 2-pass column measurement with 26-char cap and responsive description wrapping.
- [x] [03-subcommand-markers-and-footers.md](.ai-memory/plans/subtasks/27-terminal-ui/03-subcommand-markers-and-footers.md) — Expandable subcommand markers (`▸ subcommands`) and standard version footers.
- [x] [04-verification.md](.ai-memory/plans/subtasks/27-terminal-ui/04-verification.md) — Verify all terminal UI test suites and linters pass cleanly.
...
1. **Subtask 01 (`.ai-memory/plans/subtasks/36-cli-help/01-command-registration-and-examples.md`)**:
   Verify that all CLI commands, subcommands, flags, and options have complete descriptions and practical terminal examples.
2. **Subtask 02 (`.ai-memory/plans/subtasks/36-cli-help/02-helptext-ast-parity.md`)**:
   Verify Go AST parity and helptext consistency tests.
3. **Subtask 03 (`.ai-memory/plans/subtasks/36-cli-help/03-ci-runner-verification.md`)**:
...
1. **Subtask 01 (`.ai-memory/plans/subtasks/41-terminal-ui/01-ansi-palette-and-box-drawing.md`)**:
   Verify bright bold ANSI palette and Catppuccin pastel cycling in terminal constants.
2. **Subtask 02 (`.ai-memory/plans/subtasks/41-terminal-ui/02-responsive-alignment-and-banners.md`)**:
   Verify responsive 2-column help layout and super-category intent banners.
3. **Subtask 03 (`.ai-memory/plans/subtasks/41-terminal-ui/03-ci-runner-verification.md`)**:
...
**Status:** complete
**Created:** 2026-09-09
**Specification:** `02-spec/21-macro-builder-enhancements/`
...
- [`.ai-memory/memory/learned/10-interactive-macro-builder-pwd-ls-commands.md`](.ai-memory/memory/learned/10-interactive-macro-builder-pwd-ls-commands.md)
