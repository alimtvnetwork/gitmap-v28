...
**Spec Reference:** [`02-spec/25-chrome-profile-management/01-profile-registration-and-picker.md`](../../../02-spec/25-chrome-profile-management/01-profile-registration-and-picker.md)
**Related Issue:** [`.ai-memory/memory/issues/2026-09-05-chrome-profile-picker-visibility-desync.md`](../../memory/issues/2026-09-05-chrome-profile-picker-visibility-desync.md)
...
- **Requirements:**
  ...
  - `gitmap chrome import-check --tempfile <filename>` writing to `.ai-memory/temp/<filename>`.
...
- [`.ai-memory/memory/issues/2026-09-05-chrome-profile-picker-visibility-desync.md`](.ai-memory/memory/issues/2026-09-05-chrome-profile-picker-visibility-desync.md)
- [`.ai-memory/memory/learned/11-chrome-profile-import-routing-and-fnf-export.md`](.ai-memory/memory/learned/11-chrome-profile-import-routing-and-fnf-export.md)
