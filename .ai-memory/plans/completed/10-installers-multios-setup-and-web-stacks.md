...
**Target Path:** `03-ai-scripts/01-file-manipulator.py`
...
5. **Update Index**: After generating the script, you MUST document its usage in `03-ai-scripts/index.md`.
...
- [ ] I saved the script precisely to `03-ai-scripts/01-file-manipulator.py`.
...
- [ ] I updated `03-ai-scripts/index.md` with instructions on how to use this new script.
...
- Reference images saved to `.ai-memory/assets/help-ui/`
...
- **Authoritative Specifications Implemented:**
  - [`02-spec/01-app/01-installer/01-installer-suite.md`](02-spec/01-app/01-installer/01-installer-suite.md) — Multi-OS binary installer, PATH configuration, and shell completion.
  - [`02-spec/01-app/08-zsh/01-zsh-setup.md`](02-spec/01-app/08-zsh/01-zsh-setup.md) — Automated Oh-My-Zsh setup, plugins, and custom themes on Ubuntu/Debian.
  - [`02-spec/02-coding-guidelines/06-ai-optimization/05-citation-requirement.md`](02-spec/02-coding-guidelines/06-ai-optimization/05-citation-requirement.md) — Strict repository-relative Git paths (banning `file:///` and absolute drive letters).
- **Core Architecture Contracts:**
  - Self-contained AI helper scripts housed strictly in `03-ai-scripts/` (`01-file-manipulator.py` to `06-file-hygiene-fixer.py`).
...
| 3 | AI Tooling & Fix Scripts | Built reusable repository normalizers and local test runners | `03-ai-scripts/*.py` | DONE |
...
- [`.ai-memory/memory/issues/07-relative-path-breakage.md`](.ai-memory/memory/issues/07-relative-path-breakage.md) — Absolute path eradication in agent memory.
...
- **Subtask 22.02:** Remove superseded micro-task files and empty subtask directories in `.ai-memory/plans/completed/`.
- **Subtask 22.03:** Re-sequence `.ai-memory/plans/completed/` to contiguous `01-` through `06-` using `01-file-manipulator.py`.
- **Subtask 22.04:** Synchronize `.ai-memory/plans/index.md` and `.ai-memory/memory/00-index.md` and verify with all relative path and spacing linters.
...
**Parent Plan:** [.ai-memory/plans/pending/78-nginx-wordpress-laravel-installation-and-configuration.md](../../pending/78-nginx-wordpress-laravel-installation-and-configuration.md)
**Status:** Completed
...
**Parent Plan:** [.ai-memory/plans/completed/80-vmware-shared-mount-fix-install-and-root-help.md](../../completed/80-vmware-shared-mount-fix-install-and-root-help.md)
**Status:** Completed
...
**Parent Task Workflow:** Parent Task N-Step Continuous Loop & Multi-Agent Orchestration (Prompt v2.1.0)
**Budget (N):** 50 steps
**Target Directory:** `.ai-memory/plans/completed/`
...
**Parent Plan:** `.ai-memory/plans/pending/90-vmware-shared-crontab-persistence-fix.md`
...
2. Update `.ai-memory/plans/01-index.md` and move plan to completed.
...
- [`.ai-memory/memory/issues/2026-09-08-linux-corrupted-ansi-install-directory.md`](.ai-memory/memory/issues/2026-09-08-linux-corrupted-ansi-install-directory.md)
- [`.ai-memory/memory/issues/2026-09-09-antigravity-cli-vs-ide-conflation.md`](.ai-memory/memory/issues/2026-09-09-antigravity-cli-vs-ide-conflation.md)
- [`.ai-memory/memory/learned/12-vmware-shared-mount-and-crontab-persistence.md`](.ai-memory/memory/learned/12-vmware-shared-mount-and-crontab-persistence.md)
