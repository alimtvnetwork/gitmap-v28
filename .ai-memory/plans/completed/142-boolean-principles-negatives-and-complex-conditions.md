...
- `02-spec/02-coding-guidelines/01-cross-language/01-index.md`: Hallucination prevention, micro-tasking, and strict relative paths.
- `02-spec/02-coding-guidelines/01-cross-language/02-boolean-principles/01-index.md`: Boolean principles index, implicit checks, and inverse patterns.
- `02-spec/02-coding-guidelines/01-cross-language/02-boolean-principles/02-naming-prefixes.md`: Principle 1 (`is`/`has` prefixes only) and Principle 2 (total ban on negative words `no`, `not`, `non`).
- `02-spec/02-coding-guidelines/01-cross-language/02-boolean-principles/04-parameters-and-conditions.md`: Principle 6 (ban on mixed polarity in single if conditions).
- `02-spec/02-coding-guidelines/01-cross-language/12-no-negatives.md`: Positive guard functions and semantic inverse pairs.
- `02-spec/02-coding-guidelines/01-cross-language/22-variable-naming-conventions.md`: Affirmative boolean variable naming rules.
- `02-spec/02-coding-guidelines/02-canonical-size-tier.md`: File and function size limits (functions <= 8–15 lines, files <= 100 lines).
...
- **Subtask 01:** `.ai-memory/plans/subtasks/142-booleans/01-banned-function-prefixes-and-negative-vars.md`
...
- **Subtask 02:** `.ai-memory/plans/subtasks/142-booleans/02-negative-options-and-struct-fields.md`
...
- **Subtask 03:** `.ai-memory/plans/subtasks/142-booleans/03-eliminate-mixed-polarity-in-cli-cmd.md`
...
- **Subtask 04:** `.ai-memory/plans/subtasks/142-booleans/04-upgrade-linter-and-verify-quality-gates.md`
