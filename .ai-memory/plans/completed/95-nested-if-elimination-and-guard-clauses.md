...
- `02-spec/02-coding-guidelines/02-canonical-size-tier.md`: Universal size limits and zero nested `if` mandate (functions <= 8 lines preferred, hard cap 15 lines; files <= 100 coding lines).
- `02-spec/02-coding-guidelines/01-cross-language/04-code-style/02-braces-and-nesting.md`: Elimination of nested conditional pyramids and mandatory braces.
- `02-spec/02-coding-guidelines/01-cross-language/04-code-style/04-blank-lines-and-spacing.md`: Blank lines before `return` and after closing `}` (R13-R16).
- `02-spec/02-coding-guidelines/01-cross-language/04-code-style/05-function-and-type-size.md`: Function size caps and extraction of single-purpose helpers.
- `02-spec/02-coding-guidelines/06-ai-optimization/01-index.md`: Zero truncation, zero placeholders, zero ghost diffs.
...
- **Subtask 01:** `.ai-memory/plans/subtasks/95-nested-if-elimination-and-guard-clauses/01-task-flatten-cmd-nested-ifs.md`
...
- **Subtask 02:** `.ai-memory/plans/subtasks/95-nested-if-elimination-and-guard-clauses/02-task-flatten-store-nested-ifs-and-ci-register.md`
