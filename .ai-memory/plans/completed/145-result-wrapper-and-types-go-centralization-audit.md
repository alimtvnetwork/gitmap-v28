...
- `02-spec/02-coding-guidelines/01-cross-language/01-index.md`: Single return type mandate and micro-tasking.
- `02-spec/02-coding-guidelines/01-cross-language/27-types-folder-convention.md`: Types.go and single type definitions.
- `02-spec/02-coding-guidelines/02-canonical-size-tier.md`: File and function size limits (functions <= 8–15 lines, files <= 100–300 lines).
- `02-spec/03-error-manage/01-index.md`: Universal AppError wrapping and error envelopes.
- `02-spec/03-error-manage/02-error-architecture/02-error-handling-reference.md`: Error handling architecture and Result wrappers.
- `02-spec/03-error-manage/02-error-architecture/06-apperror-package/01-apperror-reference/04-result-types.md`: Result[T], ResultSlice[T], and ResultMap[K, V] method specifications and pointer null-safety rules.
- `.agents/skills/cg-result-wrapper/skill.md`: Canonical skill for result wrappers and AppError returns.
- `.ai-memory/coding-guidelines.md`: Master consolidated coding guidelines.
...
- **Subtask 01:** `.ai-memory/plans/subtasks/145-result-wrapper/01-result-types-centralization-and-affirmative-field.md`
...
- **Subtask 02:** `.ai-memory/plans/subtasks/145-result-wrapper/02-cmdschedule-types-and-bundle-result.md`
...
- **Subtask 03:** `.ai-memory/plans/subtasks/145-result-wrapper/03-macro-and-pipelinedb-types-centralization.md`
...
- **Subtask 04:** `.ai-memory/plans/subtasks/145-result-wrapper/04-auditor-linter-and-quality-gates-verification.md`
