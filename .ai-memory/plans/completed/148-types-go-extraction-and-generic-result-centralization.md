...
- `02-spec/02-coding-guidelines/01-cross-language/01-index.md`: Hallucination prevention, micro-tasking, strict relative paths.
...
- `02-spec/02-coding-guidelines/01-cross-language/06-type-definitions.md`: Section 6.4 centralization of domain types, enums, and Result aliases in `types.go`.
- `02-spec/02-coding-guidelines/01-cross-language/10-function-naming.md`: Semantic verb standards.
...
- `02-spec/03-error-manage/01-index.md`: Universal `*AppError` wrapping, strongly typed `Result[T]` envelopes, and zero swallowed errors.
...
| V-34 | `03-ai-scripts/06-cicd-local-runner.py` | 183 | E2E Smoke Tests Batch | Ran installer smoke tests against host OS | Removed `Installer Smoke (source)` & `(release)` | Completed |
