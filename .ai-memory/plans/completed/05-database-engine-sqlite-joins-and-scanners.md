...
2. **Dedicated Installation Split Database (`installation.db`)**:
   - Strictly adheres to `02-spec/04-database-conventions/07-split-db-pattern.md` and repository standards (`schedule_split_db.go`).
...
**Budget (N):** 150 steps
**Target Directory:** `.ai-memory/plans/pending/`
...
2. **Tesla ID Naming & Schema Convention Violations**:
   - Spec `02-spec/04-database-conventions/01-naming-conventions.md` and `02-spec/01-naming` mandate PascalCase acronyms (`Id`, `Db`, `Url`, `Api`) and forbid all-caps clusters (`ID`, `DB`, `URL`, `API`).
...
- [`.ai-memory/memory/learned/08-sqlite-scanner-and-orm-evolution.md`](.ai-memory/memory/learned/08-sqlite-scanner-and-orm-evolution.md)
- [`.ai-memory/memory/issues/2026-09-07-sqlite-database-locked.md`](.ai-memory/memory/issues/2026-09-07-sqlite-database-locked.md)
