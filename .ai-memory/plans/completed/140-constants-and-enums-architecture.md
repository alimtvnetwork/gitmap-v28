...
- `02-spec/02-coding-guidelines/01-cross-language/27-types-folder-convention.md`: Universal enum and constant conventions and mandatory `*Type` suffix.
- `02-spec/02-coding-guidelines/06-ai-optimization/05-enum-naming-quick-reference.md`: Strict naming rules for enum types and constants.
...
- **Subtask 01:** `.ai-memory/plans/subtasks/140-enums/01-audit-and-scan-enums.md`
...
- **Subtask 02:** `.ai-memory/plans/subtasks/140-enums/02-refactor-go-enums-with-type-suffix.md`
...
- **Subtask 03:** `.ai-memory/plans/subtasks/140-enums/03-verify-linters-and-milestone-consolidation.md`
