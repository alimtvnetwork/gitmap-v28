...
- **Authoritative Specifications Implemented:**
  - [`02-spec/01-app/05-ssh/01-ssh-key-management.md`](02-spec/01-app/05-ssh/01-ssh-key-management.md) — SSH key creation, listing, clipboard copying, and SQLite persistence.
  - [`02-spec/01-app/05-ssh/02-ssh-config-generation.md`](02-spec/01-app/05-ssh/02-ssh-config-generation.md) — Rebuilding `~/.ssh/config` for multiple keys and host aliases.
  - [`02-spec/01-app/09-cluster/01-cluster-nodes.md`](02-spec/01-app/09-cluster/01-cluster-nodes.md) — Node joining (`sj`), heartbeat tracking, and distributed task broadcasting.
- **Core Architecture Contracts:**
...
- [`.ai-memory/memory/issues/04-ssh-keygen-windows-path.md`](.ai-memory/memory/issues/04-ssh-keygen-windows-path.md) — Windows OpenSSH path resolution fix.
...
2. **Commit & Release**:
   ...
   - Update `readme.md`, `version.json`, `changelog.md`, `.ai-memory/what-to-read.md`.
3. **Output**:
...
- [`.ai-memory/memory/issues/04-ssh-keygen-windows-path.md`](.ai-memory/memory/issues/04-ssh-keygen-windows-path.md)
