...
- **9 Truncated Stub Skills Upgraded to Full Engines:**
  - `ci-cd-fix/skill.md` (upgraded from 27-line stub to full 352-line engine; adapted `02-spec/` to `02-spec/`)
  - `coding-guidelines/skill.md` (upgraded from 44-line stub to full 671-line engine; adapted `02-spec/` to `02-spec/`)
...
### 3. Prompts Catalog Synchronization (`01-prompts/`, `prompts/`, `.ai-memory/prompts.md`)
...
- Installed `.ai-memory/prompts.md` (Version 3.0.0 master index).
- Created `.ai-memory/01-index.md` as repository-level context & directory router.
