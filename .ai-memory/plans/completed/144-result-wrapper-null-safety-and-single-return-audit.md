...
- `02-spec/03-error-manage/02-error-architecture/05-response-envelope/05-response-envelope-reference.md`: Response envelope schemas.
...
- **Subtask 01:** `.ai-memory/plans/subtasks/144-result-wrapper/01-result-wrapper-pointer-null-safety.md`
...
- **Subtask 02:** `.ai-memory/plans/subtasks/144-result-wrapper/02-caller-modernization-and-fluent-predicates.md`
...
- **Subtask 03:** `.ai-memory/plans/subtasks/144-result-wrapper/03-cmdschedule-resultslice-migration.md`
...
- **Subtask 04:** `.ai-memory/plans/subtasks/144-result-wrapper/04-automated-linter-and-quality-gates-verification.md`
