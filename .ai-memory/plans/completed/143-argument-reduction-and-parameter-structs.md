...
- `02-spec/02-coding-guidelines/01-cross-language/01-index.md`: Hallucination prevention, micro-tasking, strict relative paths, and Rule 9a/9b multi-line parameter formatting.
- `02-spec/02-coding-guidelines/01-cross-language/02-boolean-principles/02-naming-prefixes.md`: Principle 1 (`is`/`has` prefixes only) and Principle 2 (total ban on negative words).
- `02-spec/02-coding-guidelines/01-cross-language/10-function-naming.md`: Semantic verb and predicate prefix standards.
...
- `02-spec/03-error-manage/01-index.md`: Universal `*AppError` wrapping, `Result[T]` envelopes, and zero swallowed errors.
...
- **Subtask 01:** `.ai-memory/plans/subtasks/143-params/01-cloner-parameter-structs-and-track-result.md`
...
- **Subtask 02:** `.ai-memory/plans/subtasks/143-params/02-cloner-concurrent-and-interactive-structs.md`
...
- **Subtask 03:** `.ai-memory/plans/subtasks/143-params/03-clonepick-parameter-reduction-and-boolean-prefixes.md`
...
- **Subtask 04:** `.ai-memory/plans/subtasks/143-params/04-automated-linter-and-quality-gates-verification.md`
