...
## Objective
Regenerate `.ai-memory/test-inventory.json` with 100% relative `cli/...` test targets.
...
- Consolidation:
  - Combine subtasks into `.ai-memory/plans/completed/123-rename-gitmap-to-cli-and-updater-folder-refactor.md`.
