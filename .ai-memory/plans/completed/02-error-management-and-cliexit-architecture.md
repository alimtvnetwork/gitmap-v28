...
- **Authoritative Specifications Implemented:**
  - [`02-spec/03-error-manage/02-error-architecture/00-overview.md`](02-spec/03-error-manage/02-error-architecture/00-overview.md) — Unified error model with domain codes, severity levels, and operation context.
  - [`02-spec/03-error-manage/02-error-architecture/04-response-envelopes.md`](02-spec/03-error-manage/02-error-architecture/04-response-envelopes.md) — Universal JSON response envelopes across all CLI endpoints.
  - [`02-spec/03-error-manage/03-cli-exit-codes/`](02-spec/03-error-manage/03-cli-exit-codes/) — Standardized process exit codes via `cliexit.HandleError`.
- **Core Architecture Contracts:**
...
- [`.ai-memory/memory/issues/03-unwrapped-error-propagation.md`](.ai-memory/memory/issues/03-unwrapped-error-propagation.md) — Error wrapping traceability fix.
...
2. **Subtask 2: AST Refactor Script for Handlers**
   - Create a Go AST/Regex script in `.ai-memory/temp-scripts/refactor_cmds.go`.
...
##### 1. Verbatim Acceptance Criteria Echo (from 02-spec/03-error-manage/97-acceptance-criteria.md)
...
1. **Subtask 01 (`.ai-memory/plans/subtasks/28-error-management/01-cliexit-specialized-helpers.md`)**:
...
2. **Subtask 02 (`.ai-memory/plans/subtasks/28-error-management/02-leaf-error-returns-refactoring.md`)**:
...
3. **Subtask 03 (`.ai-memory/plans/subtasks/28-error-management/03-linter-enhancement-and-ci-verification.md`)**:
...
- [`.ai-memory/memory/issues/2026-08-25-cliexit-error-suppression.md`](.ai-memory/memory/issues/2026-08-25-cliexit-error-suppression.md)
