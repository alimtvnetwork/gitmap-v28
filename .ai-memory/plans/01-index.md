...
1. [Plan 210: 210-ssh-multi-command-discovery-and-agy-terminal-verification.md](completed/210-ssh-multi-command-discovery-and-agy-terminal-verification.md): SSH Multi-Command, Multi-Machine Join, Open Port 22 Discovery, Terminal Display Package & AGY Help Parity Verification
2. [Plan 209: 209-ssh-multi-command-discovery-and-agy-terminal-verification.md](completed/209-ssh-multi-command-discovery-and-agy-terminal-verification.md): SSH Multi-Command & Machine Discovery, Terminal Display Package, AGY Commands & Help Parity End-to-End Verification
3. [Plan 208: 208-ssh-multi-machine-and-agy-terminal-verification.md](completed/208-ssh-multi-machine-and-agy-terminal-verification.md): SSH Multi-Command & Machine Discovery, Terminal Display Package, AGY Commands & Help Parity End-to-End Verification
4. [Plan 207: 207-pipeline-errors-agy-fix-comprehensive-verification-and-audit.md](completed/207-pipeline-errors-agy-fix-comprehensive-verification-and-audit.md): Pipeline Errors AGY Fix Comprehensive Verification and Audit
5. [Plan 206: 206-pipeline-errors-agy-fix-and-multi-project-batch-hardening.md](completed/206-pipeline-errors-agy-fix-and-multi-project-batch-hardening.md): Pipeline Errors AGY Fix and Multi-Project Batch Hardening
5. [Plan 205: 205-pipeline-errors-agy-fix-injection-and-multi-project-batching.md](completed/205-pipeline-errors-agy-fix-injection-and-multi-project-batching.md): Pipeline Errors AGY Fix Direct Injection, Full Error Logs, Absolute Paths & Multi-Project Batching
...
2. [Plan 191: 191-ssh-config-sanitize-clone-force-and-cluster-help-parity.md](completed/191-ssh-config-sanitize-clone-force-and-cluster-help-parity.md): SSH Config Sanitizer, Clone Force/Reclone Flag, Cluster SSH Join and SC Help Parity
...
4. [Plan 176: 176-wrapped-result-dispatch-and-apperror.md](completed/176-wrapped-result-dispatch-and-apperror.md): Wrapped Result Dispatch Architecture & Universal AppError Retention
5. [Plan 175: 175-pipeline-errors-perf-and-ci-fixes.md](completed/175-pipeline-errors-perf-and-ci-fixes.md): Pipeline Errors Performance Optimization & CI Failure Fixes
...
7. [Plan 147: 147-argument-reduction-and-parameter-structs.md](completed/147-argument-reduction-and-parameter-structs.md): Parameter structs across cluster, clone, and visibility modules
8. [Plan 148: 148-types-go-extraction-and-generic-result-centralization.md](completed/148-types-go-extraction-and-generic-result-centralization.md): Package types.go centralization and E2E install test segregation
9. [Plan 149: 149-installer-urls-dryrun-path-and-v6-227-0-release.md](completed/149-installer-urls-dryrun-path-and-v6-227-0-release.md): Installer seed data URLs, release dryrun path fix, and v6.227.0 release
10. [Plan 150: 150-startup-crontab-schedule-async-storage.md](completed/150-startup-crontab-schedule-async-storage.md): Startup crontabs, schedule subcommands, async background worker, and storage display
11. [Plan 151: 151-fix-antigravity-installer-and-aliases.md](completed/151-fix-antigravity-installer-and-aliases.md): Antigravity & Agy installer, alias mapping, and desktop fallback
12. [Plan 152: 152-fix-antigravity-and-universal-uninstall.md](completed/152-fix-antigravity-and-universal-uninstall.md): Official GCS Antigravity installation, Linux desktop cleanup, universal uninstall engine, and stack traces
13. [Plan 153: 153-install-tar-gz-zip-linux.md](completed/153-install-tar-gz-zip-linux.md): Linux archive package installer (`gitmap install tar <archive>`)
14. [Plan 154: 154-os-ip-zsh-user-parity.md](completed/154-os-ip-zsh-user-parity.md): OS IP, ZSH, and User Management Parity Suite across Ubuntu, Debian, CentOS, and Windows
15. [Plan 155: 155-antigravity-crossplatform-installer.md](completed/155-antigravity-crossplatform-installer.md): Antigravity Cross-Platform Installer Suite across Linux, Windows, and macOS
16. [Plan 156: 156-macro-schedule-service-table-os-suite.md](completed/156-macro-schedule-service-table-os-suite.md): Macro, Schedule, Service, OS & Terminal Table Alignment Suite
17. [Plan 157: 157-os-fix-clean-profiles-clone-suite.md](completed/157-os-fix-clean-profiles-clone-suite.md): OS Fix, Clean, User, User-Group, VSCode Profiles & Clone Suite
...
- [198-terminal-ssh-execution-audit-and-ui-help-parity.md](completed/198-terminal-ssh-execution-audit-and-ui-help-parity.md): 198-terminal-ssh-execution-audit-and-ui-help-parity
...
- [154-os-ip-zsh-user-parity.md](completed/154-os-ip-zsh-user-parity.md): 154-os-ip-zsh-user-parity
- [155-antigravity-crossplatform-installer.md](completed/155-antigravity-crossplatform-installer.md): 155-antigravity-crossplatform-installer
- [156-macro-schedule-service-table-os-suite.md](completed/156-macro-schedule-service-table-os-suite.md): 156-macro-schedule-service-table-os-suite
...
- [01-fix-cicd-runner.md](completed/01-fix-cicd-runner.md): 01-fix-cicd-runner
- [02-error-management-and-cliexit-architecture.md](completed/02-error-management-and-cliexit-architecture.md): 02-error-management-and-cliexit-architecture
- [03-type-safety-function-signatures-and-contracts.md](completed/03-type-safety-function-signatures-and-contracts.md): 03-type-safety-function-signatures-and-contracts
- [04-cicd-pipelines-runners-and-streaming-telemetry.md](completed/04-cicd-pipelines-runners-and-streaming-telemetry.md): 04-cicd-pipelines-runners-and-streaming-telemetry
- [05-database-engine-sqlite-joins-and-scanners.md](completed/05-database-engine-sqlite-joins-and-scanners.md): 05-database-engine-sqlite-joins-and-scanners
- [06-git-operations-commit-engines-and-remediation.md](completed/06-git-operations-commit-engines-and-remediation.md): 06-git-operations-commit-engines-and-remediation
- [07-ssh-nodes-cluster-delegation-and-remote-exec.md](completed/07-ssh-nodes-cluster-delegation-and-remote-exec.md): 07-ssh-nodes-cluster-delegation-and-remote-exec
- [08-terminal-ui-help-parity-and-cli-commands.md](completed/08-terminal-ui-help-parity-and-cli-commands.md): 08-terminal-ui-help-parity-and-cli-commands
- [09-chrome-profile-management-picker-and-token-vault.md](completed/09-chrome-profile-management-picker-and-token-vault.md): 09-chrome-profile-management-picker-and-token-vault
- [10-installers-multios-setup-and-web-stacks.md](completed/10-installers-multios-setup-and-web-stacks.md): 10-installers-multios-setup-and-web-stacks
- [100-data-and-schema-architecture.md](completed/100-data-and-schema-architecture.md): 100-data-and-schema-architecture
- [101-react-frontend-architecture.md](completed/101-react-frontend-architecture.md): 101-react-frontend-architecture
- [102-code-hygiene-and-encoding-architecture.md](completed/102-code-hygiene-and-encoding-architecture.md): 102-code-hygiene-and-encoding-architecture
- [103-style-guidelines-and-formatting.md](completed/103-style-guidelines-and-formatting.md): 103-style-guidelines-and-formatting
- [104-testing-and-coverage-architecture.md](completed/104-testing-and-coverage-architecture.md): 104-testing-and-coverage-architecture
- [105-relative-paths-and-absolute-path-elimination.md](completed/105-relative-paths-and-absolute-path-elimination.md): 105-relative-paths-and-absolute-path-elimination
- [106-cli-commands-and-help-parity-architecture.md](completed/106-cli-commands-and-help-parity-architecture.md): 106-cli-commands-and-help-parity-architecture
- [107-function-signatures-and-return-types.md](completed/107-function-signatures-and-return-types.md): 107-function-signatures-and-return-types
- [108-typescript-guidelines-and-types.md](completed/108-typescript-guidelines-and-types.md): 108-typescript-guidelines-and-types
- [109-multi-language-enums-and-traits.md](completed/109-multi-language-enums-and-traits.md): 109-multi-language-enums-and-traits
- [11-completed-plans-consolidation.md](completed/11-completed-plans-consolidation.md): 11-completed-plans-consolidation
- [110-terminal-ui-and-cli-styling.md](completed/110-terminal-ui-and-cli-styling.md): 110-terminal-ui-and-cli-styling
- [111-function-argument-reduction-and-params.md](completed/111-function-argument-reduction-and-params.md): 111-function-argument-reduction-and-params
- [112-clone-next-dry-run-guard.md](completed/112-clone-next-dry-run-guard.md): 112-clone-next-dry-run-guard
- [113-enhanced-pipeline-error-logs.md](completed/113-enhanced-pipeline-error-logs.md): 113-enhanced-pipeline-error-logs
- [114-macro-live-execution-copy-explorer-browser.md](completed/114-macro-live-execution-copy-explorer-browser.md): 114-macro-live-execution-copy-explorer-browser
- [115-macro-file-ops-docs-and-ui-help.md](completed/115-macro-file-ops-docs-and-ui-help.md): 115-macro-file-ops-docs-and-ui-help
- [116-nuclear-package-splitting-and-slow-tests.md](completed/116-nuclear-package-splitting-and-slow-tests.md): 116-nuclear-package-splitting-and-slow-tests
- [117-nuclear-package-modularization-phase2.md](completed/117-nuclear-package-modularization-phase2.md): 117-nuclear-package-modularization-phase2
- [118-macro-multi-format-export-import.md](completed/118-macro-multi-format-export-import.md): 118-macro-multi-format-export-import
- [119-macro-export-import-robustness.md](completed/119-macro-export-import-robustness.md): 119-macro-export-import-robustness
- [12-git-deleted-files-tracer-and-purger.md](completed/12-git-deleted-files-tracer-and-purger.md): 12-git-deleted-files-tracer-and-purger
- [120-nuclear-package-modularization-phase3.md](completed/120-nuclear-package-modularization-phase3.md): 120-nuclear-package-modularization-phase3
- [121-nuclear-package-modularization-phase4.md](completed/121-nuclear-package-modularization-phase4.md): 121-nuclear-package-modularization-phase4
- [122-smart-test-runner-and-inventory-architecture.md](completed/122-smart-test-runner-and-inventory-architecture.md): 122-smart-test-runner-and-inventory-architecture
- [123-rename-gitmap-to-cli-and-updater-folder-refactor.md](completed/123-rename-gitmap-to-cli-and-updater-folder-refactor.md): 123-rename-gitmap-to-cli-and-updater-folder-refactor
- [124-runner-in-flight-heartbeat-and-ai-sleep-protocol.md](completed/124-runner-in-flight-heartbeat-and-ai-sleep-protocol.md): 124-runner-in-flight-heartbeat-and-ai-sleep-protocol
- [125-nuclear-package-modularization-phase5.md](completed/125-nuclear-package-modularization-phase5.md): 125-nuclear-package-modularization-phase5
- [126-nuclear-package-modularization-phase6.md](completed/126-nuclear-package-modularization-phase6.md): 126-nuclear-package-modularization-phase6
- [127-smart-test-runner-and-inventory-v2.md](completed/127-smart-test-runner-and-inventory-v2.md): 127-smart-test-runner-and-inventory-v2
- [128-rename-gitmap-to-cli-and-cleanup.md](completed/128-rename-gitmap-to-cli-and-cleanup.md): 128-rename-gitmap-to-cli-and-cleanup
- [129-smart-test-runner-and-eta-sleep-sync.md](completed/129-smart-test-runner-and-eta-sleep-sync.md): 129-smart-test-runner-and-eta-sleep-sync
- [130-nuclear-package-modularization-phase7.md](completed/130-nuclear-package-modularization-phase7.md): 130-nuclear-package-modularization-phase7
- [131-nuclear-package-modularization-phase8.md](completed/131-nuclear-package-modularization-phase8.md): 131-nuclear-package-modularization-phase8
- [132-nuclear-package-modularization-phase9.md](completed/132-nuclear-package-modularization-phase9.md): 132-nuclear-package-modularization-phase9
- [133-nuclear-package-modularization-phase10.md](completed/133-nuclear-package-modularization-phase10.md): 133-nuclear-package-modularization-phase10
- [134-pipeline-compact-error-logs.md](completed/134-pipeline-compact-error-logs.md): 134-pipeline-compact-error-logs
- [135-repo-scoped-temp-storage-and-prebuild-clean.md](completed/135-repo-scoped-temp-storage-and-prebuild-clean.md): 135-repo-scoped-temp-storage-and-prebuild-clean
- [136-pipeline-repo-db-compact-and-detailed-logs.md](completed/136-pipeline-repo-db-compact-and-detailed-logs.md): 136-pipeline-repo-db-compact-and-detailed-logs
- [137-repo-scoped-temp-storage-and-prebuild-clean-audit.md](completed/137-repo-scoped-temp-storage-and-prebuild-clean-audit.md): 137-repo-scoped-temp-storage-and-prebuild-clean-audit
- [138-result-wrapper-types-and-apperror-returns.md](completed/138-result-wrapper-types-and-apperror-returns.md): 138-result-wrapper-types-and-apperror-returns
- [139-nested-if-elimination-and-guard-clauses.md](completed/139-nested-if-elimination-and-guard-clauses.md): 139-nested-if-elimination-and-guard-clauses
- [140-constants-and-enums-architecture.md](completed/140-constants-and-enums-architecture.md): 140-constants-and-enums-architecture
- [141-result-wrapper-and-slice-returns.md](completed/141-result-wrapper-and-slice-returns.md): 141-result-wrapper-and-slice-returns
- [142-boolean-principles-negatives-and-complex-conditions.md](completed/142-boolean-principles-negatives-and-complex-conditions.md): 142-boolean-principles-negatives-and-complex-conditions
- [143-argument-reduction-and-parameter-structs.md](completed/143-argument-reduction-and-parameter-structs.md): 143-argument-reduction-and-parameter-structs
- [182-agy-table-grouping-tasks-suite-author-and-footer-fix.md](completed/182-agy-table-grouping-tasks-suite-author-and-footer-fix.md): 182-agy-table-grouping-tasks-suite-author-and-footer-fix
- [183-file-and-function-size-reduction.md](completed/183-file-and-function-size-reduction.md): 183-file-and-function-size-reduction
- [85-macro-path-expansion-mkdir-and-execution-streaming.md](completed/85-macro-path-expansion-mkdir-and-execution-streaming.md): 85-macro-path-expansion-mkdir-and-execution-streaming
- [86-installer-location-gap-and-duplicate-binary-rca.md](completed/86-installer-location-gap-and-duplicate-binary-rca.md): 86-installer-location-gap-and-duplicate-binary-rca
- [88-pipeline-errorlogs-incremental-db-and-history.md](completed/88-pipeline-errorlogs-incremental-db-and-history.md): 88-pipeline-errorlogs-incremental-db-and-history
- [89-scripts-fixer-installers-audit-and-parity.md](completed/89-scripts-fixer-installers-audit-and-parity.md): 89-scripts-fixer-installers-audit-and-parity
- [90-db-transaction-mechanism-and-package-audit.md](completed/90-db-transaction-mechanism-and-package-audit.md): 90-db-transaction-mechanism-and-package-audit
- [91-macro-interactive-streaming-and-execution-audit.md](completed/91-macro-interactive-streaming-and-execution-audit.md): 91-macro-interactive-streaming-and-execution-audit
- [92-sync-prompts-and-skills-from-coding-guidelines.md](completed/92-sync-prompts-and-skills-from-coding-guidelines.md): 92-sync-prompts-and-skills-from-coding-guidelines
- [93-db-transaction-mechanism-repo-wide-confirmation.md](completed/93-db-transaction-mechanism-repo-wide-confirmation.md): 93-db-transaction-mechanism-repo-wide-confirmation
- [94-error-management-and-apperror-architecture.md](completed/94-error-management-and-apperror-architecture.md): 94-error-management-and-apperror-architecture
- [95-nested-if-elimination-and-guard-clauses.md](completed/95-nested-if-elimination-and-guard-clauses.md): 95-nested-if-elimination-and-guard-clauses
- [96-booleans-and-complex-conditions-audit.md](completed/96-booleans-and-complex-conditions-audit.md): 96-booleans-and-complex-conditions-audit
