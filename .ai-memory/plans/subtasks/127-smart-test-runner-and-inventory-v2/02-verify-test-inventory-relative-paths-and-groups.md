...
2. Preserve all summary metrics in `.ai-memory/test-inventory.json`: `slow_tests`, `fast_tests`, `heavy_tests`, `unit_tests`, `slow_threshold_sec`, `estimated_slow_sec`, `estimated_fast_sec`.
