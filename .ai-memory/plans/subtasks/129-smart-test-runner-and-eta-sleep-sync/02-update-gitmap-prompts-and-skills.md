...
1. Update prompts in `01-prompts/16-ci-cd/`:
   - Document `.ai-memory/temp/failures/` failure log isolation.
   ...
   - Document dynamic ETA sleep protocol using `.ai-memory/temp/runner-eta.json` (AI sleeps instead of looping, re-checks remaining ETA if still running).
