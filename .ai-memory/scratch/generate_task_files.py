...
inverted = read_lines(r"d:\wp-work\riseup-asia\gitmap\.ai-memory\scratch\inverted_bools.txt", 50)
nested = read_lines(r"d:\wp-work\riseup-asia\gitmap\.ai-memory\scratch\nested_ifs.txt", 50)
monolithic = read_lines(r"d:\wp-work\riseup-asia\gitmap\.ai-memory\scratch\monolithic.txt", 50)
bare_bools = read_lines(r"d:\wp-work\riseup-asia\gitmap\.ai-memory\scratch\bare_bools.txt", 50)

os.makedirs(r"d:\wp-work\riseup-asia\gitmap\.ai-memory\plans\subtasks\01-coding-guideline-fixes", exist_ok=True)
os.makedirs(r"d:\wp-work\riseup-asia\gitmap\.ai-memory\plans\pending", exist_ok=True)

# Write 01-inverted-booleans.md
with open(r"d:\wp-work\riseup-asia\gitmap\.ai-memory\plans\subtasks\01-coding-guideline-fixes\01-inverted-booleans.md", "w") as f:
...
with open(r"d:\wp-work\riseup-asia\gitmap\.ai-memory\plans\subtasks\01-coding-guideline-fixes\02-nested-ifs.md", "w") as f:
...
with open(r"d:\wp-work\riseup-asia\gitmap\.ai-memory\plans\subtasks\01-coding-guideline-fixes\03-monolithic-functions.md", "w") as f:
...
with open(r"d:\wp-work\riseup-asia\gitmap\.ai-memory\plans\subtasks\01-coding-guideline-fixes\04-bare-bools.md", "w") as f:
...
# Write master plan
with open(r"d:\wp-work\riseup-asia\gitmap\.ai-memory\plans\pending\01-coding-guideline-fixes.md", "w") as f:
    ...
    f.write("\n## Subtasks\n")
    f.write("- [ ] `.ai-memory/plans/subtasks/01-coding-guideline-fixes/01-inverted-booleans.md`\n")
    f.write("- [ ] `.ai-memory/plans/subtasks/01-coding-guideline-fixes/02-nested-ifs.md`\n")
    f.write("- [ ] `.ai-memory/plans/subtasks/01-coding-guideline-fixes/03-monolithic-functions.md`\n")
    f.write("- [ ] `.ai-memory/plans/subtasks/01-coding-guideline-fixes/04-bare-bools.md`\n")
