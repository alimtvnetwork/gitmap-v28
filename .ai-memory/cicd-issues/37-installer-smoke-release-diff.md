...
2. Created `03-ai-scripts/04-relative-path-fixer.py` and converted 107 files across `.ai-memory/`, `02-spec/`, and scripts to strictly relative Git root paths.
3. Built `linter-scripts/check-relative-paths.py` and registered `Relative Path Check` in both `.github/workflows/ci.yml` and `03-ai-scripts/03-cicd-local-runner.py`.
