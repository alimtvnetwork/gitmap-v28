...
The build failed when reading `.ai-memory/cicd-issues/index.md` or `readme.md` during version bumping because Python on Windows defaulted to `cp1252` instead of UTF-8 when encountering emojis or unicode characters in markdown files.
