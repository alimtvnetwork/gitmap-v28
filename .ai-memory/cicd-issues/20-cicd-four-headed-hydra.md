...
4. `policy-check`: Found legacy references to `gitmap-v6` in `02-spec/` markdown files. <!-- gitmap-legacy-ref-allow -->
...
4. Legacy markdown files hardcoded previous sibling repository names (e.g. `gitmap-v6`), violating the policy scanner for `gitmap-v[567]\b`. <!-- gitmap-legacy-ref-allow -->
...
4. Replaced all occurrences of `gitmap-v6` in `spec/**/*.md` with `gitmap-v28`. <!-- gitmap-legacy-ref-allow -->
