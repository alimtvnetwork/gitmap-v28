...
4. Verified that all tests (`go test ./... -count=1`) and `03-ai-scripts/02-cicd-local-runner.py` pass 100% locally with 0 lint errors and 0 vet warnings.
...
- ALWAYS test with `03-ai-scripts/02-cicd-local-runner.py` before pushing.
