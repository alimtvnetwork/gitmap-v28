...
description: Append-only numbered registry of forbidden actions; mirrors 02-spec/03-general/10-strictly-prohibited.md.
type: constraint
---
...
3. **commit-in:** Never store file content, file hashes, or diff payloads in any commit-in table. Only `RelativePath` strings. **Why:** `git cat-file` already gives byte-exact content on demand. See `02-spec/03-commit-in/01-overview-and-glossary.md` INV-06.
