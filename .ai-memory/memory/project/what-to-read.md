...
| 2 | `.ai-memory/memory/index.md` | Master memory index — Core rules + topic links |
| 3 | `.ai-memory/overview.md` | Project overview & invariants |
| 4 | `.ai-memory/strictly-avoid.md` | Hard prohibitions (do NOT violate) |
| 5 | `.ai-memory/coding-guidelines.md` | Code style + size limits |
| 6 | `.ai-memory/plan.md` | Active roadmap |
| 7 | `02-spec/03-general/10-strictly-prohibited.md` | Spec-level forbidden actions |
...
```
02-spec/08-json-schemas/<name>.schema.json    ← contract (JSON Schema draft-07)
        │
...
| Layer | File |
|---|---|
| Schema | `02-spec/08-json-schemas/amend-audit.schema.json` |
...
### Existing JSON surfaces (all live in `02-spec/08-json-schemas/`)
...
1. **Author the schema** → `02-spec/08-json-schemas/<new-name>.schema.json`
...
- Version bump procedure → `.ai-memory/memory/project/version-bump-procedure.md`.
- Strictly prohibited actions → `.ai-memory/memory/constraints/strictly-prohibited.md`.
- Code style limits → `.ai-memory/memory/style/code-constraints.md`.
