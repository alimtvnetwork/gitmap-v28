...
- `02-spec/03-commit-in/` — README + 7 iteration files (overview / CLI / pipeline / DB+ERD / profiles+JSON / message+fn-intel / acceptance).
- `.ai-memory/plan.md` — appended 7-phase gated implementation plan.
- `.ai-memory/memory/features/commit-in.md` + index entry.
