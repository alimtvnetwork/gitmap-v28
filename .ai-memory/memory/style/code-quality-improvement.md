...
Process name: **Code Quality Improvement**. All coding guidelines are documented in `02-spec/05-coding-guidelines/01-code-quality-improvement.md`. Universal rules (all languages including TypeScript and Go):
...
Go-specific rules remain in `02-spec/03-general/06-code-style-rules.md` and `02-spec/04-generic-cli/08-code-style.md`.
