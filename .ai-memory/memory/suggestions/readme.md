...
- Active suggestions: `.ai-memory/memory/suggestions/`
- Archived (done) suggestions: `.ai-memory/memory/suggestions/archive/`
- Legacy freeform log: `.ai-memory/memory/suggestions/01-suggestions.md` (kept as historical; do not extend)
...
# Fix 02-spec/01-app prefix collisions
...
4. Move the file to `.ai-memory/memory/suggestions/archive/` in the same commit that flips to done. Never delete.
