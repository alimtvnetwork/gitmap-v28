...
All CI tool installs use exact version tags — `go install tool@latest` is prohibited for reproducibility. See `02-spec/05-coding-guidelines/17-cicd-patterns.md`.
