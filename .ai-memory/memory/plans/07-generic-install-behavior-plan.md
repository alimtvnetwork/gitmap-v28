...
**Spec of record:** `02-spec/07-generic-release/09-generic-install-script-behavior.md`
...
| File                                                  | Change                                                                                |
|-------------------------------------------------------|---------------------------------------------------------------------------------------|
| `cli/release/installsnippet.go` + `constants_release.go` | No code change required — snippet already passes `--version`, which triggers §3 correctly. Add a comment pointing at 02-spec/07-generic-release/09. |
| `02-spec/01-app/95-installer-script-find-latest-repo.md` | Add a banner at the top: "§4 fail-fast clause superseded by 02-spec/07-generic-release/09 §4.1 (20-parallel max-hit-wins). This document remains valid for context." |
| `02-spec/07-generic-release/08-pinned-version-install-snippet.md` | Add a "See also" pointer to spec 09. No semantic change. |
...
1. Copy `02-spec/07-generic-release/09-generic-install-script-behavior.md`
   into its own `02-spec/` tree verbatim. The text is repo-agnostic; only
