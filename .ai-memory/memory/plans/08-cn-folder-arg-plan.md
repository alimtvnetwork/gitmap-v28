...
Spec: [02-spec/01-app/111-cn-folder-arg.md](../../../02-spec/01-app/111-cn-folder-arg.md)
...
- [x] Write `02-spec/01-app/111-cn-folder-arg.md`
- [x] Write this plan file (`08-cn-folder-arg-plan.md`)
- [x] Append memory entry to `.ai-memory/memory/index.md`
