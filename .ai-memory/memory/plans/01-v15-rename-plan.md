...
**Spec:** https://github.com/alimtvnetwork/coding-guidelines-v15/blob/main/02-spec/04-database-conventions/01-naming-conventions.md
...
- Update `02-spec/12-consolidated-guidelines/11-database.md` to v15 (singular + `{Table}Id`).
