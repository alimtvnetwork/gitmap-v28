...
Spec: `02-spec/01-app/110-templates-polish.md` ✅ (v3.108.0)
...
- [ ] Write `02-spec/01-app/110-templates-polish.md` covering: new langs, `init` UX, `diff` UX, exit codes, dry-run semantics.
