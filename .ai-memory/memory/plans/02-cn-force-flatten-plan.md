...
| File | Change |
|---|---|
| `02-spec/01-app/87-clone-next-flatten.md` | Document `-f` flag + use case + interaction table |
...
| `.ai-memory/memory/features/clone-next-flatten.md` | Updated with v3.50.0 force section |
