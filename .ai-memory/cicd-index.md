...
Tracks every CI/CD pipeline failure or hardening decision encountered, its root cause, and resolution. New entries go in `.ai-memory/cicd-issues/XX-short-name.md` with sequential numeric prefixes.
