...
| Key | Value | Phase |
|-----|-------|-------|
| Slug | `task-tracker` | [Phase 1, §1.8](03-foundation-and-architecture.md) |
| ShortName | `TaskTracker` | — |
| Namespace | `TaskTracker\` | — |
| API namespace | `task-tracker-api/v1` | [Phase 14, §14.1](15-rest-api-conventions.md) |
| Debug constant | `TASK_TRACKER_DEBUG` | [Phase 4, §4.2](05-logging-and-error-handling.md) |
