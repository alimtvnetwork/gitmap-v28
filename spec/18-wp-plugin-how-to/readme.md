...
| 14 | [14-rest-api-conventions.md](14-rest-api-conventions.md) | REST API Conventions | Route naming, namespace patterns, HTTP method selection, pagination, category grouping, `endpoints.json` format, controller organization |
