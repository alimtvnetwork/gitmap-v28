...
> **Updated:** 2026-03-19
> **Status:** Active
> **Location:** `02-spec/powershell-integration/`
...
```
02-spec/powershell-integration/
...
02-spec/upload-scripts/              ← Related: WordPress plugin upload scripts
...
Tell the AI:
> "Follow the spec at `02-spec/powershell-integration/` to add the PowerShell build runner. Create a `powershell.json` config for my project structure. Enable pnpm PnP for disk-efficient package management."
...
_Auto-generated section — see `02-spec/11-powershell-integration/97-acceptance-criteria.md` for the full criteria index._
