...
| Reference | Location |
|-----------|----------|
| Spec Root | [../01-index.md](../01-index.md) |
...
_Auto-generated section — see `02-spec/04-database-conventions/97-acceptance-criteria.md` for the full criteria index._

### AC-DB-001: Database convention conformance: Index
