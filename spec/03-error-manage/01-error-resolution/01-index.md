...
|---|--------|-------------|-------|
| 03 | [03-retrospectives/](./03-retrospectives/01-index.md) | Case studies of resolved time-wasting issues | 4 |
| 04 | [04-verification-patterns/](./04-verification-patterns/01-index.md) | Mandatory verification protocols | 1 |
| 05 | [05-debugging-guides/](./05-debugging-guides/01-index.md) | Language-specific debugging guides (PHP, Go, TS) | 3 |
