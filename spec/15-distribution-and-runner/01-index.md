...
- CICD pipeline conventions: [`02-spec/12-cicd-pipeline-workflows/`](../12-cicd-pipeline-workflows/)
...
_Auto-generated section — see `02-spec/15-distribution-and-runner/97-acceptance-criteria.md` for the full criteria index._
