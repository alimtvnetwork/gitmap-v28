...
- [spec/05-coding-guidelines/17-cicd-patterns.md](../02-coding-guidelines/17-cicd-patterns.md) — CI/CD patterns
- [spec/05-coding-guidelines/29-ci-sha-deduplication.md](../02-coding-guidelines/29-ci-sha-deduplication.md) — SHA dedup pattern
- [spec/02-app-issues/13-release-pipeline-dist-directory.md](../22-app-issues/13-release-pipeline-dist-directory.md) — `dist` directory post-mortem
