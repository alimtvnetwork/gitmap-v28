...
> - App reference: [spec/01-app/31-cd.md](../31-cd.md) — gitmap-v28 navigation helper that consumes this contract
...
> - Consolidated guideline: [spec/12-consolidated-guidelines/19-post-install-shell-activation.md](../17-consolidated-guidelines/19-post-install-shell-activation.md)
