...
Symmetric counterpart to BE-1 but flowing **backward**. Cataloged as **BE-6** for Phase-12 merge into `07-core-api-endpoints.md`.
...
This section formalizes the dispositions of v1.0 open questions so dumb-AI implementers do not re-litigate them mid-implementation. Each disposition is **binding** for v1.0; the Future-Work block at the bottom names what a v2.0 spec MUST cover if a disposition is reopened. Pattern mirrors `13-jwt-delivery-contract.md` §11.
