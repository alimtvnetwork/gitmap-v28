...
Everything else — including DNS resolution of the primary worker's FQDN — SHOULD be firewalled at the host level. See `25-threat-model.md` (when materialized) for the firewall recipe.
