...
1. Confirm `spec/14-update/` covers every behavior summarized in §3 of this file. Diff §3 against `spec/14-update/00-overview.md` — any remaining gap blocks deletion.
