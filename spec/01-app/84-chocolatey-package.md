...
Publish `gitmap-v28` as a Chocolatey package so users can install via:

```powershell
choco install gitmap-v28
```
...
<package xmlns="http://schemas.chocolatey.org/2012/06/nuspec">
  <metadata>
    ...
    <projectUrl>https://github.com/alimtvnetwork/gitmap-v28</projectUrl>
    <licenseUrl>https://github.com/alimtvnetwork/gitmap-v28/blob/main/LICENSE</licenseUrl>
    ...
    <projectSourceUrl>https://github.com/alimtvnetwork/gitmap-v28</projectSourceUrl>
    <packageSourceUrl>https://github.com/alimtvnetwork/gitmap-v28</packageSourceUrl>
    <releaseNotes>https://github.com/alimtvnetwork/gitmap-v28/releases</releaseNotes>
  </metadata>
  <files>
...
$packageArgs = @{
  packageName    = 'gitmap-v28'
  url64bit       = 'https://github.com/alimtvnetwork/gitmap-v28/releases/download/v2.49.1/gitmap-v28.49.1-windows-amd64.zip'
...
5. **Test locally:**
   ```
   choco install gitmap-v28 --debug --verbose --source .
   ```
