...
- [Error Handling](../21-app/04-generic-cli/07-error-handling.md) — CLI error handling patterns
- [Error Handling Patterns](../02-coding-guidelines/04-error-handling.md) — Cross-language error patterns
- [Verbose Logging](../21-app/04-generic-cli/16-verbose-logging.md) — Debug logging system
