...
See [02-cross-compilation.md](02-cross-compilation.md) for the full
...
| App Spec | Covers |
|----------|--------|
| [05-release-pipeline.md](../12-cicd-pipeline-workflows/05-release-pipeline.md) | Cross-compilation, checksums, and release-job orchestration |
| [10-code-signing.md](../12-cicd-pipeline-workflows/10-code-signing.md) | SignPath integration, signing step placement, and SmartScreen reputation |
| [16-release-versioning.md](../14-update/16-release-versioning.md) | Version resolution, release metadata, and tag synchronization |
