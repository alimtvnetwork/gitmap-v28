...
4. Release notes were generated at `.ai-memory/release/release-notes-v6.190.0.md`.
5. Root `readme.md` was pinned to active version `v6.190.0`.
6. `.ai-memory/user-preferences` was updated to reflect active version `v6.190.0`.
...
5. `.ai-memory/user-preferences` — Pinned active version `v6.190.0`.
...
2. `.ai-memory/release/release-notes-v6.190.0.md` — Generated release notes.
