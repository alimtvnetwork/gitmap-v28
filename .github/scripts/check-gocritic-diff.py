#!/usr/bin/env python3
"""Cross-platform gocritic baseline-diff runner and gate.

Executes golangci-lint with the 'gocritic' analyzer, normalizes results,
and validates against baseline to prevent any style/performance regressions.
...
def main():
    ...
    os.environ.setdefault("LINTER", "gocritic")
    os.environ.setdefault("LABEL", "gocritic")
