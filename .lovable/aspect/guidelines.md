...
- **NO MAGIC STRINGS**: Do not introduce any magic strings or magic numbers anywhere in the codebase (Go or TS), unless explicitly required for a logger message, and mention that in the typing/comments.
