...
- **MANDATORY USAGE**: All queries or operations that can fail in TypeScript/PHP/Python **MUST** be wrapped using a centralized wrapper (e.g., `queryWrapper.ts` or `query_wrapper.py`).
