...
- [ ] "### Issues" block present in the changelog if any step failed or was flagged, with links to ".lovable/release/issues/".
...
- [ ] Report includes previous version, new version, bump tier, and exact file list.
