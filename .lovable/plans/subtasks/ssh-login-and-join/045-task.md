...
citations:
  ...
  tests: "unit TestrunIPChangeCmd"
  ci_cd_guard: ".github/workflows/ci.yml"
  ambiguity: "n/a"
  issue_rca: "n/a"
---
# Task 045 — Scaffold `gitmap ip-change` cmd
...
## 2. Goal
Deliver the Scaffold step for `runIPChangeCmd` to support the Scaffold `gitmap ip-change` cmd feature. This is isolated logic for the SSH/IP subdomains.
...
## 4. Execute
1. Define argument structure `[new-ip]`.
...
## 7. Done When
- [ ] 1. `runIPChangeCmd` is fully functional.
