...
citations:
  ...
  ui_surface: "n/a"
  tests: "unit TestInitCloneUIPart2"
  ci_cd_guard: "n/a — spec gap filed"
  ambiguity: ".lovable/ambiguous-questions/01-new-ambiguity/01-spec-gaps.md"
  issue_rca: "n/a"
---
# Task 002 — Implement CloneUI - Part 2

## 1. Learn
- [Go Style](file:///d:/work/gitmap/spec/05-coding-guidelines/02-go-code-style.md) - why: styling 2
- [DB Patterns](file:///d:/work/gitmap/spec/05-coding-guidelines/11-database-patterns.md) - why: db 2
- [Error handling](file:///d:/work/gitmap/spec/05-coding-guidelines/04-error-handling.md) - why: errors 2
- [Custom Link 2](file:///d:/work/gitmap/spec/05-coding-guidelines/03-naming-conventions.md) - why: convention 2

## 2. Goal
Isolate CloneUI logic for part 2. This ensures modular architecture.

## 3. Inputs and Contracts
Consumes CloneUIRequest, emits CloneUIResponse.

## 4. Execute
1. Define 	ype CloneUIPart2 struct { ... } in gitmap/cmd/clone_ui.go.
2. Define unc InitCloneUIPart2() error in gitmap/cmd/clone_ui.go.
3. Define unc (x *CloneUIPart2) Process2() bool in gitmap/cmd/clone_ui.go.

## 5. Constraints
- Code style: spec/05-coding-guidelines/02-go-code-style.md

## 6. Verify
go test -run TestInitCloneUIPart2 ./...
expected: ok

## 7. Done When
- [ ] Code compiles
- [ ] Tests pass
- [ ] 	ype CloneUIPart2 is defined
- [ ] unc InitCloneUIPart2 is implemented
