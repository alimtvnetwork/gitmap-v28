...
citations:
  ...
  ui_surface: "n/a"
  tests: "unit TestInitInstallExportPart2"
...
## 1. Learn
- [Go Style](file:///d:/work/gitmap/spec/05-coding-guidelines/02-go-code-style.md) - why: styling 48
- [DB Patterns](file:///d:/work/gitmap/spec/05-coding-guidelines/11-database-patterns.md) - why: db 48
- [Error handling](file:///d:/work/gitmap/spec/05-coding-guidelines/04-error-handling.md) - why: errors 48
- [Custom Link 48](file:///d:/work/gitmap/spec/05-coding-guidelines/03-naming-conventions.md) - why: convention 48
