---
description: "Migrate gitmap.db schema to support Format='zip' and 'sqlite'"
...
# Task: Migrate gitmap.db schema to support Format='zip' and 'sqlite'

## 1. Intent
Implement the specific logic for: Migrate gitmap.db schema to support Format='zip' and 'sqlite'.
