---
description: "Add --format flag support to runChromeProfileImport"
...
# Task: Add --format flag support to runChromeProfileImport

## 1. Intent
Implement the specific logic for: Add --format flag support to runChromeProfileImport.
