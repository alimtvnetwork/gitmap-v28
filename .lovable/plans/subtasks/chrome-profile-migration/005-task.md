---
description: "Define zipExportRecord struct in chromeprofile_db.go"
...
# Task: Define zipExportRecord struct in chromeprofile_db.go

## 1. Intent
Implement the specific logic for: Define zipExportRecord struct in chromeprofile_db.go.
