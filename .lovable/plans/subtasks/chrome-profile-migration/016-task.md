---
description: "Update defaultChromeExportPath to handle .zip and .sqlite"
...
# Task: Update defaultChromeExportPath to handle .zip and .sqlite

## 1. Intent
Implement the specific logic for: Update defaultChromeExportPath to handle .zip and .sqlite.
