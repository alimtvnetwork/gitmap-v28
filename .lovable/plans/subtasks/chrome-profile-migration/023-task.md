---
description: "Handle Profile merging when SQLite databases exist"
...
# Task: Handle Profile merging when SQLite databases exist

## 1. Intent
Implement the specific logic for: Handle Profile merging when SQLite databases exist.
