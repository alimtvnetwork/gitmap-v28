...
citations:
  ...
  ui_surface: "n/a"
  tests: "unit TestInitHDDownloadPart2"
...
## 1. Learn
- [Go Style](file:///d:/work/gitmap/spec/05-coding-guidelines/02-go-code-style.md) - why: styling 10
- [DB Patterns](file:///d:/work/gitmap/spec/05-coding-guidelines/11-database-patterns.md) - why: db 10
- [Error handling](file:///d:/work/gitmap/spec/05-coding-guidelines/04-error-handling.md) - why: errors 10
- [Custom Link 10](file:///d:/work/gitmap/spec/05-coding-guidelines/03-naming-conventions.md) - why: convention 10
