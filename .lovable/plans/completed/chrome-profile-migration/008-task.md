---
description: "Implement Chrome SQLite file copy routine (Windows)"
...
# Task: Implement Chrome SQLite file copy routine (Windows)

## 1. Intent
Implement the specific logic for: Implement Chrome SQLite file copy routine (Windows).
