---
description: "Update writeChromeExport to conditionally output zip format"
...
# Task: Update writeChromeExport to conditionally output zip format

## 1. Intent
Implement the specific logic for: Update writeChromeExport to conditionally output zip format.
