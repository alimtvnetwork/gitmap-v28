---
description: "Implement Chrome SQLite file copy routine (Linux)"
...
# Task: Implement Chrome SQLite file copy routine (Linux)

## 1. Intent

Implement the specific logic for: Implement Chrome SQLite file copy routine (Linux).
