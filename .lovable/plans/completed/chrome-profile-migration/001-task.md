---
description: "Analyze Chrome SQLite Schema for Export (History, Web Data)"
...
# Task: Analyze Chrome SQLite Schema for Export (History, Web Data)

## 1. Intent
Implement the specific logic for: Analyze Chrome SQLite Schema for Export (History, Web Data).
