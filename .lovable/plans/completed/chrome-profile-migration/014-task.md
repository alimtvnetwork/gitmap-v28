---
description: "Update writeChromeExport to conditionally output sqlite only"
...
# Task: Update writeChromeExport to conditionally output sqlite only

## 1. Intent

Implement the specific logic for: Update writeChromeExport to conditionally output sqlite only.
