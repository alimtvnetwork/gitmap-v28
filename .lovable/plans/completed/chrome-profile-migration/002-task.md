---
description: "Define Cross-OS File Mapping (Windows vs Linux)"
...
# Task: Define Cross-OS File Mapping (Windows vs Linux)

## 1. Intent

Implement the specific logic for: Define Cross-OS File Mapping (Windows vs Linux).
