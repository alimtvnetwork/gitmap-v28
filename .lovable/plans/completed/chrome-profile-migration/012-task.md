---
description: "Write SQLite payloads to ZIP archive"
...
# Task: Write SQLite payloads to ZIP archive

## 1. Intent
Implement the specific logic for: Write SQLite payloads to ZIP archive.
