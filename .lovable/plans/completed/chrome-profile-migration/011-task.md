---
description: "Filter out encrypted DBs (Login Data, Cookies) from Export"
...
# Task: Filter out encrypted DBs (Login Data, Cookies) from Export

## 1. Intent

Implement the specific logic for: Filter out encrypted DBs (Login Data, Cookies) from Export.
