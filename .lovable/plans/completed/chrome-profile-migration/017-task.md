---
description: "Update emitChromeSnapshots for multi-format output"
...
# Task: Update emitChromeSnapshots for multi-format output

## 1. Intent

Implement the specific logic for: Update emitChromeSnapshots for multi-format output.
