---
description: "Update printChromeArtifacts to handle zip/sqlite files"
...
# Task: Update printChromeArtifacts to handle zip/sqlite files

## 1. Intent
Implement the specific logic for: Update printChromeArtifacts to handle zip/sqlite files.
