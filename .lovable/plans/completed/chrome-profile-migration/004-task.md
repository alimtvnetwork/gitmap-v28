---
description: "Update chromeprofile.go to Parse --format=zip|json|sqlite"
...
# Task: Update chromeprofile.go to Parse --format=zip|json|sqlite

## 1. Intent

Implement the specific logic for: Update chromeprofile.go to Parse --format=zip|json|sqlite.
