---
description: "Update README and CLI Help Text for new format flags"
...
# Task: Update README and CLI Help Text for new format flags

## 1. Intent
Implement the specific logic for: Update README and CLI Help Text for new format flags.
