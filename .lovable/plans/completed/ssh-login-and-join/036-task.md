...
domain: Cli
phase: Implement
target_files: ["gitmap/cmd/sshjoin_ls_cmd.go"]
depends_on: [Task 004, Task 035]
citations:
  ...
  tests: "unit TestprintSJList"
  ci_cd_guard: ".github/workflows/ci.yml"
  ambiguity: "n/a"
  issue_rca: "n/a"
---
# Task 036 — Implement SJ List Output
...
- [gitmap/cmd/sshjoin_ls_cmd.go](file:///d:/work/gitmap/gitmap/cmd/sshjoin_ls_cmd.go) — Why: Target file.

## 2. Goal
Deliver the Implement step for `printSJList` to support the Implement SJ List Output feature. This is isolated logic for the SSH/IP subdomains.
...
## 4. Execute
1. Fetch all hosts (requires new store method `ListHosts`).
...
## 7. Done When
- [ ] 1. `printSJList` is fully functional.
