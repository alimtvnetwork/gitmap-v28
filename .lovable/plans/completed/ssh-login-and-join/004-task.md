...
citations:
  ...
  tests: "unit TestGetHostByAlias"
  ci_cd_guard: ".github/workflows/ci.yml"
  ambiguity: "n/a"
  issue_rca: "n/a"
---
# Task 004 — Implement SSHHost Get by Alias
...
- [gitmap/store/ssh_repo.go](file:///d:/work/gitmap/gitmap/store/ssh_repo.go) — Why: Target file.

## 2. Goal
Deliver the Implement step for `GetHostByAlias` to support the Implement SSHHost Get by Alias feature. This is isolated logic for the SSH/IP subdomains.
...
## 4. Execute
1. Write `GetHostByAlias(ctx context.Context, alias string) (SSHHost, error)`.
...
## 7. Done When
- [ ] 1. `GetHostByAlias` is fully functional.
