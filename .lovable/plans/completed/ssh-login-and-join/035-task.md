...
citations:
  ...
  tests: "unit TestrunSJLs"
  ci_cd_guard: ".github/workflows/ci.yml"
  ambiguity: "n/a"
  issue_rca: "n/a"
---
# Task 035 — Scaffold `gitmap sj ls` cmd
...
## 2. Goal
Deliver the Scaffold step for `runSJLs` to support the Scaffold `gitmap sj ls` cmd feature. This is isolated logic for the SSH/IP subdomains.
...
## 4. Execute
1. Command for listing joined machines.
