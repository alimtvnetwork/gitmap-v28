...
citations:
  ...
  tests: "unit TestrunSSHLogin"
  ci_cd_guard: ".github/workflows/ci.yml"
  ambiguity: "n/a"
  issue_rca: "n/a"
---
# Task 021 — Scaffold `gitmap ssh login` cmd
...
- [gitmap/cmd/ssh_login_cmd.go](gitmap/cmd/ssh_login_cmd.go) — Why: Target file.

## 2. Goal
Deliver the Scaffold step for `runSSHLogin` to support the Scaffold `gitmap ssh login` cmd feature. This is isolated logic for the SSH/IP subdomains.
...
## 4. Execute
1. Define cobra command or custom CLI runner function.
2. Bind args `[target]`.
...
## 7. Done When
- [ ] 1. `runSSHLogin` is fully functional.
