...
1. [Plan 193: 193-pipeline-fix-errors-agy-suite.md](completed/193-pipeline-fix-errors-agy-suite.md): Pipeline Fix Errors AGY (AEF) Full Alias Suite, Direct Fix Routing, and Antigravity Queue Verification
2. [Plan 192: 192-pipeline-fix-errors-agy-queue-and-force-flag.md](completed/192-pipeline-fix-errors-agy-queue-and-force-flag.md): Pipeline Fix Errors AGY (AEF), Duplicate Detection (--force), and Antigravity Queue Dispatch
