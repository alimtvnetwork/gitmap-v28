...
- `.lovable/prompts/cg-execute/index.md`, why: Sequenced N-step autonomous prompts for enforcing every section of the coding guidelines with CI/CD linter integration.
