...
- The AI must maintain an explicit register of the last 20 tasks/plans in `.lovable/plans/01-index.md` under `## Recent Completed Tasks Register (Last 20 Tasks)`.
- This register must be referenced in `.lovable/what-to-read.md`.
