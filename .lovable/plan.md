...
- `gitmap/constants/constants.go` → `Version = "6.85.0"`
- `src/constants/index.ts` → `6.85.0`
- `.gitmap/release/v6.85.0.json` (copy the v6.84.0 shape) and update `.gitmap/release/latest.json`
- `changelog.md` → new `v6.85.0` section: release ceremony and version sync
- `readme.md` → repin every `v6.84.0` occurrence to `v6.85.0`
