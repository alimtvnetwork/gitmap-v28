...
- `gitmap/constants/constants.go` → `Version = "6.87.0"`
- `src/constants/index.ts` → `6.87.0`
- `.gitmap/release/v6.87.0.json` (copy the v6.85.0 shape) and update `.gitmap/release/latest.json`
- `changelog.md` → new `v6.87.0` section: maintenance bump
- `readme.md` → repin every `v6.85.0` occurrence to `v6.87.0`
