...
type pickCloneStrategyCase struct {
	name      string
...
var pickCloneStrategyCases = []pickCloneStrategyCase{
	{
...
func TestPickCloneStrategy(t *testing.T) {
	for _, tc := range pickCloneStrategyCases {
		t.Run(tc.name, func(t *testing.T) {
			assertPickCloneStrategy(t, tc)
		})
	}
}

func assertPickCloneStrategy(t *testing.T, tc pickCloneStrategyCase) {
	t.Helper()
