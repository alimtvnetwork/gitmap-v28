...
func serveStatic(distDir string, port int) {
	...
	if err != nil && err != http.ErrServerClosed {
		cliexit.HandleError(apperror.WrapSimple(err, constants.ErrHDServe))
...
func serveDev(docsDir string, port int) {
	...
	if err := install.Run(); err != nil {
		cliexit.HandleError(apperror.WrapSimple(err, constants.ErrHDNPMInstall))
	...
	if err := dev.Start(); err != nil {
		cliexit.HandleError(apperror.WrapSimple(err, constants.ErrHDDevServer))
