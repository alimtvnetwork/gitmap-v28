...
func toolingUtilEntries() []dispatchEntry {
	return []dispatchEntry{
		{[]string{"schedule"}, func() error { return runSchedule(argsTail()) }},
		...
		{[]string{constants.CmdAg, constants.CmdAntigravity}, func() error { return runAg(argsTail()) }},
		{[]string{constants.CmdLlm}, func() error { return runLlm(argsTail()) }},
		{[]string{constants.CmdFind}, func() error { return runFind(argsTail()) }},
		{[]string{constants.CmdFindFiles}, func() error { return runFindFiles(argsTail()) }},
		{[]string{constants.CmdFindFilesAny}, func() error { return runFindFilesAny(argsTail()) }},
		{[]string{constants.CmdFindFilesStartsWith}, func() error { return runFindFilesStartsWith(argsTail()) }},
		{[]string{constants.CmdFindFilesEndsWith}, func() error { return runFindFilesEndsWith(argsTail()) }},
		{[]string{constants.CmdListFiles}, func() error { return runListFiles(argsTail()) }},
