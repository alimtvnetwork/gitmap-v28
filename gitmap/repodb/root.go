...
func InitRootSchema(ctx context.Context, db *sql.DB) error {
	query := "CREATE TABLE IF NOT EXISTS IndexedRepo ( IndexedRepoId INTEGER PRIMARY KEY AUTOINCREMENT, Path TEXT NOT NULL UNIQUE, Slug TEXT NOT NULL, MigratedVersion INTEGER NOT NULL, CreatedAt INTEGER NOT NULL, UpdatedAt INTEGER NOT NULL );"
