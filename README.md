...
**Pinned version: v6.79.0**

[![CI](https://img.shields.io/github/actions/workflow/status/alimtvnetwork/gitmap-v27/ci.yml?style=flat-square&label=CI)](https://github.com/alimtvnetwork/gitmap-v27/actions/workflows/ci.yml)
[![Vulnerability Scan](https://img.shields.io/github/actions/workflow/status/alimtvnetwork/gitmap-v27/vulncheck.yml?style=flat-square&label=vulnerability%20scan)](https://github.com/alimtvnetwork/gitmap-v27/actions/workflows/vulncheck.yml)
[![Cross-Platform Build](https://img.shields.io/github/actions/workflow/status/alimtvnetwork/gitmap-v27/cross-platform.yml?style=flat-square&label=cross-platform%20build)](https://github.com/alimtvnetwork/gitmap-v27/actions/workflows/cross-platform.yml)
[![Startup Build-Tag Guard](https://img.shields.io/github/actions/workflow/status/alimtvnetwork/gitmap-v27/startup-build-tags.yml?style=flat-square&label=startup%20build-tag%20guard)](https://github.com/alimtvnetwork/gitmap-v27/actions/workflows/startup-build-tags.yml)
[![GitHub Release](https://img.shields.io/github/v/release/alimtvnetwork/gitmap-v27?style=flat-square&label=version)](https://github.com/alimtvnetwork/gitmap-v27/releases)
[![Go](https://img.shields.io/badge/Go-1.23+-00ADD8?style=flat-square&logo=go&logoColor=white)](https://go.dev)
[![Platform](https://img.shields.io/badge/platform-Windows%20%7C%20Linux%20%7C%20macOS-lightgrey?style=flat-square)](https://github.com/alimtvnetwork/gitmap-v27)
[![License](https://img.shields.io/badge/license-MIT-green?style=flat-square)](./LICENSE)
[![Go Report Card](https://goreportcard.com/badge/github.com/alimtvnetwork/gitmap-v27/gitmap?style=flat-square)](https://goreportcard.com/report/github.com/alimtvnetwork/gitmap-v27/gitmap)
...
```powershell
irm https://raw.githubusercontent.com/alimtvnetwork/gitmap-v27/main/install.ps1 | iex
```

### 🐧 macOS · Linux · Bash (latest)

```bash
curl -fsSL https://raw.githubusercontent.com/alimtvnetwork/gitmap-v27/main/install.sh | sh
```
...
```powershell
# Windows · PowerShell
irm https://github.com/alimtvnetwork/gitmap-v27/releases/download/v6.79.0/release-version-v6.79.0.ps1 | iex
```

```bash
# macOS · Linux · Bash
curl -fsSL https://github.com/alimtvnetwork/gitmap-v27/releases/download/v6.79.0/release-version-v6.79.0.sh | bash
```

#### 🧭 Version matrix — `v6.79.0` install-script URLs

One-line installers and release assets for the pinned **v6.79.0** build across every supported platform. All URLs resolve to the exact release tag — no fallback, no discovery.

| Platform | Shell | Install-script URL | Release binary asset |
| --- | --- | --- | --- |
| **Windows** (amd64) | PowerShell | [`release-version-v6.79.0.ps1`](https://github.com/alimtvnetwork/gitmap-v27/releases/download/v6.79.0/release-version-v6.79.0.ps1) | [`gitmap-v27.79.0-windows-amd64.zip`](https://github.com/alimtvnetwork/gitmap-v27/releases/download/v6.79.0/gitmap-v27.79.0-windows-amd64.zip) |
| **macOS** (arm64) | Bash | [`release-version-v6.79.0.sh`](https://github.com/alimtvnetwork/gitmap-v27/releases/download/v6.79.0/release-version-v6.79.0.sh) | [`gitmap-v27.79.0-darwin-arm64.tar.gz`](https://github.com/alimtvnetwork/gitmap-v27/releases/download/v6.79.0/gitmap-v27.79.0-darwin-arm64.tar.gz) |
| **macOS** (amd64) | Bash | [`release-version-v6.79.0.sh`](https://github.com/alimtvnetwork/gitmap-v27/releases/download/v6.79.0/release-version-v6.79.0.sh) | [`gitmap-v27.79.0-darwin-amd64.tar.gz`](https://github.com/alimtvnetwork/gitmap-v27/releases/download/v6.79.0/gitmap-v27.79.0-darwin-amd64.tar.gz) |
| **Linux** (amd64) | Bash | [`release-version-v6.79.0.sh`](https://github.com/alimtvnetwork/gitmap-v27/releases/download/v6.79.0/release-version-v6.79.0.sh) | [`gitmap-v27.79.0-linux-amd64.tar.gz`](https://github.com/alimtvnetwork/gitmap-v27/releases/download/v6.79.0/gitmap-v27.79.0-linux-amd64.tar.gz) |
| **Linux** (arm64) | Bash | [`release-version-v6.79.0.sh`](https://github.com/alimtvnetwork/gitmap-v27/releases/download/v6.79.0/release-version-v6.79.0.sh) | [`gitmap-v27.79.0-linux-arm64.tar.gz`](https://github.com/alimtvnetwork/gitmap-v27/releases/download/v6.79.0/gitmap-v27.79.0-linux-arm64.tar.gz) |

> **Release page:** [github.com/alimtvnetwork/gitmap-v27/releases/tag/v6.79.0](https://github.com/alimtvnetwork/gitmap-v27/releases/tag/v6.79.0) · **Asset naming contract:** `gitmap-<version>-<os>-<arch>.<ext>` (`.zip` on Windows, `.tar.gz` elsewhere) — verified by the installer pre-flight HEAD probe.
...
& ([scriptblock]::Create((irm https://raw.githubusercontent.com/alimtvnetwork/gitmap-v27/main/install.ps1))) -InstallDir 'D:\tools\gitmap'

# macOS · Linux · Bash — pass --dir through curl | sh
curl -fsSL https://raw.githubusercontent.com/alimtvnetwork/gitmap-v27/main/install.sh | sh -s -- --dir /opt/gitmap
```
...
**GitMap** ([this repository](https://github.com/alimtvnetwork/gitmap-v27))
...
```powershell
Set-ExecutionPolicy Bypass -Scope Process -Force; [System.Net.ServicePointManager]::SecurityProtocol = [System.Net.ServicePointManager]::SecurityProtocol -bor 3072; iex ((New-Object System.Net.WebClient).DownloadString('https://raw.githubusercontent.com/alimtvnetwork/gitmap-v27/main/install.ps1'))
```
...
1. **Use `--allow-fallback`** — Automatically picks the newest patch in the same
   ...
   ```powershell
   irm https://github.com/alimtvnetwork/gitmap-v27/releases/download/v3.38.0/release-version-v3.38.0.ps1 | iex
...
| Script | URL Pattern |
|--------|-------------|
| Pinned PowerShell | `https://github.com/alimtvnetwork/gitmap-v27/releases/download/{version}/release-version-{version}.ps1` |
| Pinned Bash | `https://github.com/alimtvnetwork/gitmap-v27/releases/download/{version}/release-version-{version}.sh` |
...
```powershell
irm https://raw.githubusercontent.com/alimtvnetwork/gitmap-v27/main/install.ps1 | iex; Install-Gitmap -Version "v2.51.0"
```

**Specific version + custom directory (one-liner):**

```powershell
irm https://raw.githubusercontent.com/alimtvnetwork/gitmap-v27/main/install.ps1 | iex; Install-Gitmap -Version "v2.51.0" -InstallDir "D:\DevTools\gitmap"
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/alimtvnetwork/gitmap-v27/main/install.sh | sh -s -- --version v2.51.0
```
...
```bash
git clone https://github.com/alimtvnetwork/gitmap-v27.git gitmap
```
...
gitmap clone https://github.com/alimtvnetwork/gitmap-v27
gitmap clone https://github.com/alimtvnetwork/gitmap-v27 my-folder
gitmap clone git@github.com:alimtvnetwork/gitmap-v27.git my-folder
gitmap clone https://github.com/alimtvnetwork/gitmap-v27 --replace   # see spec 96

# force the transport — auto-converts HTTPS <-> SSH-shorthand before git runs
gitmap clone https://github.com/alimtvnetwork/gitmap-v27.git --ssh    # -> git@github.com:alimtvnetwork/gitmap-v27.git
gitmap clone git@github.com:alimtvnetwork/gitmap-v27.git --https      # -> https://github.com/alimtvnetwork/gitmap-v27.git
...
gitmap mv ./gitmap-v27 ./gitmap-v27
gitmap mv ./gitmap-v27 https://github.com/alimtvnetwork/gitmap-v27
gitmap mv https://github.com/alimtvnetwork/gitmap-v27 ./another-folder
gitmap mv https://github.com/alimtvnetwork/gitmap-v27 \
         https://github.com/alimtvnetwork/gitmap-v27

# merge-both: bidirectional fill (each side gains what the other has)
gitmap merge-both ./gitmap-v27 ./gitmap-v27
gitmap merge-both ./gitmap-v27 https://github.com/alimtvnetwork/gitmap-v27
gitmap merge-both https://github.com/alimtvnetwork/gitmap-v27 \
                  https://github.com/alimtvnetwork/gitmap-v27

# merge-left: take RIGHT into LEFT
gitmap merge-left ./gitmap-v27 ./gitmap-v27
gitmap merge-left ./local https://github.com/alimtvnetwork/gitmap-v27

# merge-right: take LEFT into RIGHT
gitmap merge-right ./gitmap-v27 ./gitmap-v27
gitmap merge-right ./local https://github.com/alimtvnetwork/gitmap-v27

# bypass conflict prompts: source-side wins by default
gitmap merge-right ./gitmap-v27 ./gitmap-v27 -y
gitmap merge-both  ./gitmap-v27 ./gitmap-v27 -y --prefer-newer

# pin remote branch + preview
gitmap merge-right ./local https://github.com/owner/repo:develop
gitmap mv ./gitmap-v27 ./gitmap-v27 --dry-run
```
...
# Inside gitmap-v27 (bare sweep ACTIVE on v1->v2)
#   gitmap       -> gitmap-v27
#   gitmap-v27    -> gitmap-v27
#   gitmap.js    -> gitmap.js     (word-boundary)
# Inside gitmap-v27+ (bare sweep SKIPPED)
#   gitmap                 -> gitmap                 (binary/brand preserved)
#   https://.../gitmap     -> https://.../gitmap     (URL preserved)
#   gitmap-v27, gitmap-v27   -> gitmap-v<current>
#   gitmap-v27             -> gitmap-v27             (negative-lookahead)
...
$ver = 'v3.50.0'
$installer = irm https://raw.githubusercontent.com/alimtvnetwork/gitmap-v27/main/install.ps1
& ([scriptblock]::Create($installer)) -Version $ver -NoDiscovery
```

```bash
# Linux / macOS — install v3.50.0 exactly
curl -fsSL https://raw.githubusercontent.com/alimtvnetwork/gitmap-v27/main/install.sh \
...
- 🐛 **Fixes:** README badge now points at `goreportcard.com/badge/github.com/alimtvnetwork/gitmap-v27/gitmap` (real module path) instead of the repo root, which 404'd because there is no `go.mod` at the root.
...
- 💥 **Breaking:** `go.mod` module path renamed from a placeholder to `github.com/alimtvnetwork/gitmap-v27/gitmap`. Anyone importing the module by the old path must update their import lines. CLI users are unaffected.
...
> Versions older than v3.22 are summarized in [`CHANGELOG.md`](CHANGELOG.md). Notable jumps: **v3.21** (schema-version fast path + `db-migrate --force`), **v3.19** (bare release auto-bumps **minor** + multi-repo scan-dir release), **v3.17** (`Release.RepoId` foreign key + doctor duplicate-binary check), **v3.16** (repo renamed to `gitmap-v27`).
...
[
  ...
  {
    "repoName": "gitmap-v27",
    "httpsUrl": "https://github.com/alimtvnetwork/gitmap-v27.git",
    "relativePath": "gitmap-v27",
    "depth": 1
  }
]
```
...
gitmap-v27,git@github.com:alimtvnetwork/gitmap-v27.git,,gitmap-v27
```
