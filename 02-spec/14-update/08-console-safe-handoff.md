...
- [06-handoff-mechanism.md](06-handoff-mechanism.md) — Copy-and-handoff
  foundation for Windows self-replacement
- [04-rename-first-deploy.md](04-rename-first-deploy.md) — Rename-first
  strategy for locked binaries
- [23-update-command-workflow.md](23-update-command-workflow.md) — End-to-end update runner flow in this folder
- [../12-cicd-pipeline-workflows/11-self-update-mechanism.md](../12-cicd-pipeline-workflows/11-self-update-mechanism.md) — Pipeline duties and self-update contract
- [../17-consolidated-guidelines/20-self-update-app-update.md](../17-consolidated-guidelines/20-self-update-app-update.md) — Consolidated app-level orchestration and handoff guidance
