...
| Reference | Location |
|-----------|----------|
| App Issues | `02-spec/17-consolidated-guidelines/14-app-issues.md` |
| App Database | `02-spec/17-consolidated-guidelines/22-app-database.md` |
| App Design System | `02-spec/17-consolidated-guidelines/16-app-design-system-and-ui.md` |
| Coding Guidelines | `02-spec/17-consolidated-guidelines/31-compiled-simple-coding-guidelines.md` |
| Spec Authoring Guide | `02-spec/17-consolidated-guidelines/01-spec-authoring.md` |
