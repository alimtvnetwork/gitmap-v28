...
|-------|---------------|
| Quick Start | `02-spec/18-wp-plugin-how-to/00-quick-start.md` |
| Foundation & Architecture | `02-spec/18-wp-plugin-how-to/01-foundation-and-architecture.md` |
| Enums & Coding Style | `02-spec/18-wp-plugin-how-to/02-enums-and-coding-style/` |
| Traits & Composition | `02-spec/18-wp-plugin-how-to/03-traits-and-composition.md` |
| Logging & Error Handling | `02-spec/18-wp-plugin-how-to/04-logging-and-error-handling.md` |
| Input Validation | `02-spec/18-wp-plugin-how-to/06-input-validation-patterns.md` |
| WordPress Integration | `02-spec/18-wp-plugin-how-to/08-wordpress-integration-patterns.md` |
| Deployment Patterns | `02-spec/18-wp-plugin-how-to/10-deployment-patterns.md` |
| REST API Conventions | `02-spec/18-wp-plugin-how-to/14-rest-api-conventions.md` |
| Settings Architecture | `02-spec/18-wp-plugin-how-to/15-settings-architecture.md` |
| Micro ORM & Root DB | `02-spec/18-wp-plugin-how-to/19-micro-orm-and-root-db.md` |
| Ping Endpoint | `02-spec/18-wp-plugin-how-to/21-ping-endpoint.md` |
| End-to-End Walkthrough | `02-spec/18-wp-plugin-how-to/20-end-to-end-walkthrough.md` |
