...
**Version:** 3.3.0
**Updated:** 2026-04-16
**Source:** [`02-spec/01-spec-authoring-guide/07-memory-folder-guide.md`](../01-spec-authoring-guide/07-memory-folder-guide.md)
...
*Consolidated .ai-memory folder structure — v3.3.0 — 2026-04-16*

---

## §X Project Memory — Active Core Rules (Mirror)

This section **mirrors** the operational rules stored in `.ai-memory/memory/index.md` Core section. A blind AI receiving only the consolidated folder would otherwise miss these — and violate at least three on its first PR. This mirror is **read-only documentation** of the rules; the canonical source remains `mem://index.md`.
