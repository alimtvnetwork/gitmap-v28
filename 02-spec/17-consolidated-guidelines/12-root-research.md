...
| Source folder | `02-spec/10-research/00-overview.md` |
| CI/CD pipeline specs | `02-spec/17-consolidated-guidelines/15-cicd-pipeline-workflows.md` |
| Split DB architecture | `02-spec/17-consolidated-guidelines/05-split-db-architecture.md` |
