...
The single source of truth for coding rules is [`31-compiled-simple-coding-guidelines.md`](./31-compiled-simple-coding-guidelines.md). Mirrors: `.ai-memory/coding-guidelines.md` and `.cursorrules`, auto-generated by `scripts/sync-guidelines.mjs`. File `02-coding-guidelines.md` is a redirect stub; do not restore its old body.
...
| 21 | [21-lovable-folder-structure.md](./21-lovable-folder-structure.md) | `.ai-memory/` folder structure — memory, tasks, suggestions, strictly-avoid, AI reading order |
...
| 30 | [30-readme-improvement-suggestions.md](./30-readme-improvement-suggestions.md) | **Meta** — Prioritized README rewrite plan (22 suggestions in 5 phases). Awaiting approval. Created alongside the v3.55.0 GIFs + Bundle Installers section |
