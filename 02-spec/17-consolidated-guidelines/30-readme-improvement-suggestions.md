...
| # | Suggestion | Priority |
|---|---|---|
| 17 | Add a `## For AI Agents` section right after the H1 summary listing the canonical entry points: `llm.md`, `bundles.json`, `02-spec/17-consolidated-guidelines/00-overview.md`, `.ai-memory/memory/index.md`. | 🔴 |
