...
| Reference | Location |
|-----------|----------|
| Root-level research | `02-spec/17-consolidated-guidelines/12-root-research.md` |
| Source folder | `02-spec/02-coding-guidelines/10-research/00-overview.md` |
| Coding guidelines | `02-spec/17-consolidated-guidelines/31-compiled-simple-coding-guidelines.md` |
| Spec authoring | `02-spec/17-consolidated-guidelines/01-spec-authoring.md` |
