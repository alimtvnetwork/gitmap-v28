...
2. **Threat-model document** at `02-spec/19-main-worker-service/24-threat-model.md` (does not yet exist — placeholder slot 24 is reserved by this clause).
...
- `02-spec/19-main-worker-service/05-auth-and-2fa.md` — high-level auth contract.
- `02-spec/19-main-worker-service/06-core-api-endpoints.md` §3.2 — `/Resolve` response shape.
- `02-spec/19-main-worker-service/10-worker-bootstrap-protocol.md` §3.2 — `JwtPublicKeyPem` + `JwtSigningKeyId` source.
