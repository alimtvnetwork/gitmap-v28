...
**Authority:** This file is the canonical contract for **how** a Worker receives a new version. It complements (does NOT replace) `09-self-update-pointer.md` (intent/pause note) and `02-spec/14-update/28-worker-push-instruction.md` (JSON Instruction Document schema).
...
All `WORKER-*` codes registered in `02-spec/03-error-manage/03-error-code-registry/` per `13-error-codes.md`.
