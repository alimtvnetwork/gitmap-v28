...
1. Confirm `02-spec/14-update/` covers every behavior summarized in §3 of this file. Diff §3 against `02-spec/14-update/00-overview.md` — any remaining gap blocks deletion.
2. Migrate any inbound links pointing at this file (search: `09-self-update-pointer.md`) to the equivalent anchor in `02-spec/14-update/`. Update `00-overview.md`, `plan.md`, `99-consistency-report.md`, `98-changelog.md`, and the diagrams' authority footers.
