...
- `08-error-contract.md` — main↔worker correlation IDs, retry semantics, failure taxonomy (worker-unreachable / version-mismatch / split-DB-write-fail / auth-handshake-fail). References `02-spec/03-error-manage/`, does not duplicate.
...
- Update `.ai-memory/plan.md` with v-bump entry
