...
**Version:** 1.1.0
**Created:** 2026-05-06
**Updated:** 2026-07-19 (v1.1.0: OQ-A1 promoted to D15, OQ-A2 promoted to D16; §7 rewritten as "Resolved decisions" and both items removed from `.ai-memory/plan.md` Open Questions.)
