...
- Decision register: `.ai-memory/plan.md` D14, OQ-A4.
...
1. **Threat-model document** at `02-spec/19-main-worker-service/24-threat-model.md` (slot reserved by `12-jwt-delivery-contract.md` §11.3) — must enumerate the new attack surfaces (diff-chain corruption for §14.1; partial-restore plaintext extract for §14.2).
