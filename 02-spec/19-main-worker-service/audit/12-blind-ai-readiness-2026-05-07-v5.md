...
> **Spec under audit:** `02-spec/19-main-worker-service/` (46 numbered + meta files).
...
| --- | --- | --- | ---: |
| G1 (sweep) | `audit/08-…v3.md` cited non-existent `02-spec/03-tasks/`; check-spec-folder-refs RED. | Added `03-tasks` to `[external]` allowlist (sibling-repo doc-only ref). | +0.5 |
