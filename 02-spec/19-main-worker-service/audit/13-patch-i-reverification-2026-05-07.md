...
| I-G2 | `02-spec/19-main-worker-service/25-inherited-rules.md:26` | link target was one directory too deep | corrected to sibling-relative path (`../03-error-manage/` from `25-…`) ✅ |
| I-G3a | `02-spec/19-main-worker-service/13-error-codes.md:7` | "Worker tier `21000-21099`" | **"Worker tier `21000-21099` (primary) + `21200-21299` (overflow)"** ✅ |
| I-G3b | `02-spec/19-main-worker-service/13-error-codes.md` §2.5/§2.9/§3.12 | 5 codes missing | **`WORKER-403-01/02` + `WORKER-503-01/02` + `MAIN-900-01` cataloged** ✅ |
