...
> **Spec under audit:** `02-spec/19-main-worker-service/` (43 numbered + meta files, ~563 KB).
...
`02-spec/19-main-worker-service/` is **cleared for blind-AI implementation** of the in-scope (non-backup) surface at v5.27.0. Phase 14 may open. Backup-tier work remains gated behind the v2.0.0 seed bump and an explicit feature flag.
