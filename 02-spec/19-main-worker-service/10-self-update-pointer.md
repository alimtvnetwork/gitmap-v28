...
1. Confirm `02-spec/14-update/` covers every behavior summarized in §3 of this file. Diff §3 against `02-spec/14-update/01-index.md` — any remaining gap blocks deletion.
