...
```
/docs?file=02-spec/02-coding-guidelines/01-cross-language/04-code-style/01-braces-and-nesting.md
```
...
- Paths are relative to project root (e.g., `02-spec/02-coding-guidelines/...`)
...
│                             │
│  📄 Keyboard Navigation     │
│     02-spec/08-docs-viewer-ui/ │  ← Path shown as subtext
│  📄 Fundamentals            │
│     02-spec/08-docs-viewer-ui/ │
│  📄 Coding Guidelines Spec  │
│     02-spec/02-coding-guideli… │
│                             │
└─────────────────────────────┘
```
...
| Reference | Location |
|-----------|----------|
| Theme & Animation Spec | `02-spec/08-docs-viewer-ui/02-features/06-ui-theme-animations.md` |
| Syntax Highlighting Spec | `02-spec/08-docs-viewer-ui/02-features/02-syntax-highlighting.md` |
| Typography Spec | `02-spec/08-docs-viewer-ui/02-features/01-typography.md` |
