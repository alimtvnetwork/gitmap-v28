...
| `02-spec/05-coding-guidelines/29-ci-sha-deduplication.md` | Documented the passthrough gate pattern, inlined cache write, and updated acceptance criteria |
| `.ai-memory/memory/tech/ci-pipeline-architecture.md` | Updated SHA deduplication section |
