...
- 02-spec/02-app-issues/26-docs-site-not-bundled-and-swallowed-errors.md (Issue 1)
- 02-spec/02-app-issues/27-docs-site-not-deployed-by-runscripts.md

> **Number history:** this spec is numbered **34**, not 33. Number 33 was
> previously occupied by `02-spec/02-app-issues/33-stale-binary-clone-folder-url-guard.md`
