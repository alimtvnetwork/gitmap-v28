...
- `02-spec/02-app-issues/23-go-build-copyfile-redeclared.md` — Similar Go build failure from namespace conflicts
- `02-spec/05-coding-guidelines/01-code-quality-improvement.md` — Lint enforcement rules
- `02-spec/03-general/06-code-style-rules.md` — Code style rules
