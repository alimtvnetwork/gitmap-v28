...
Repeated mismatch between general specs (`02-spec/03-general/`) and app-specific specs (`02-spec/01-app/`) for the update flow, causing implementation drift — lock/retry loops, async/foreground oscillation, missing version checks.
...
- Any update-flow change must update ALL of: `02-spec/03-general/02-powershell-build-deploy.md`, `02-spec/03-general/03-self-update-mechanism.md`, `02-spec/01-app/09-build-deploy.md`, `02-spec/01-app/02-cli-interface.md`, and `02-spec/02-app-issues/`
