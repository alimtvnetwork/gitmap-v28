...
2. **Refactor guardrail** (added to `.ai-memory/plan.md` and
   `02-spec/04-generic-cli/13-checklist.md`): After any Go file split or
...
- `02-spec/02-app-issues/14-security-hardening-gosec-fixes.md` — prior lint fixes
- `.ai-memory/plan.md` — Go refactor validation guardrail
