...
> **Related specs:**
> - `02-spec/02-app-issues/22-installer-path-not-active-after-install.md` — multi-profile contract (this issue extends it)
> - `02-spec/04-generic-cli/21-post-install-shell-activation/02-snippets.md` — per-shell snippet bodies
