...
`gitmap-v28 update` looped 20 times trying to sync the active PATH binary, failing each time due to file locks.
...
6. **Any update-flow change must update ALL of:** `cmd/update.go`, `run.ps1`, `02-spec/01-app/09-build-deploy.md`, `02-spec/03-general/02-powershell-build-deploy.md`, `02-spec/03-general/03-self-update-mechanism.md`, `02-spec/02-app-issues/`
