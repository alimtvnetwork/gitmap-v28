...
- `02-spec/05-coding-guidelines/08-security-secrets.md` — Security & Secrets
- `02-spec/02-app-issues/27-error-management-file-path-and-missing-file-code-red-rule.md` — Code Red Rule
