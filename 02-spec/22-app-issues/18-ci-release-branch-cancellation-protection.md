...
| `02-spec/03-general/08-ci-pipeline.md` | Added "Release Branch Protection" section with behavior tables |
| `.ai-memory/memory/tech/ci-pipeline-architecture.md` | Updated concurrency control section |
