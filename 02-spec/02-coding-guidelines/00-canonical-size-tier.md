...
> All other locations (`.cursorrules`, `eslint.config.js`, `linters-cicd/`, `02-spec/13-generic-cli/08-code-style.md`, `02-spec/17-consolidated-guidelines/31-compiled-simple-coding-guidelines.md`) mirror this table and MUST reference it. If any of those drift, this file wins and the others get patched.
...
| `02-spec/17-consolidated-guidelines/31-compiled-simple-coding-guidelines.md` §"File Size Limits" | Consolidated guidelines mirror |
