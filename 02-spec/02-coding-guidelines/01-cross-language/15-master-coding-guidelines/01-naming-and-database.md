...
**Spec/documentation files** are **NOT** affected — they remain lowercase kebab-case with numeric prefixes (e.g., `01-architecture.md`). See File Naming Convention <!-- external: 02-spec/02-spec-management-software/02-instructions/01-file-naming-convention.md -->.
