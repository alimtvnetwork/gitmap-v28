...
Whenever an AI agent generates code, explains a design decision, or enforces a standard, it **MUST** cite the specific `02-spec/` markdown file and line/section that justifies the action.
...
- *"Returning a structured error with context, per `02-spec/03-error-manage/02-error-architecture/01-error-handling-reference.md`."*
