...
|------------|-------------|--------|---------|
| **Folder Layout** | Numeric prefix + lowercase kebab-case | PASS | `02-spec/25-chrome-profile-management/` |
...
3. **Error Management Compliance:**
   - Complies with `02-spec/03-error-manage/` guidelines: zero silent swallows, robust error wrapping, and clear warning messages for running process collisions.
