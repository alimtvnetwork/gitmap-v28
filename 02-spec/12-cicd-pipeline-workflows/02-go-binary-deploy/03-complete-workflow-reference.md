...
jobs:
  release:
    ...
    steps:
      ...
      # See: 02-spec/12-cicd-pipeline-workflows/05-code-signing.md
      # ──────────────────────────────────────────────
      ...
      # See: 02-spec/12-cicd-pipeline-workflows/04-install-script-generation.md
      # ──────────────────────────────────────────────
      ...
      # See: 02-spec/12-cicd-pipeline-workflows/07-release-body-and-changelog.md
      # ──────────────────────────────────────────────
