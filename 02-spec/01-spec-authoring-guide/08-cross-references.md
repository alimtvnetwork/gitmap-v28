...
```markdown
See: [Guidelines](/02-spec/02-coding-guidelines/00-overview.md)
```
...
```markdown
See: [Guidelines](/dev-server/02-spec/02-coding-guidelines/00-overview.md)
```
...
| From | To | Path |
|------|----|------|
| `02-spec/09-gsearch-cli/01-backend/01-arch.md` | `02-spec/02-coding-guidelines/00-overview.md` | `../../02-coding-guidelines/00-overview.md` |
| `02-spec/09-gsearch-cli/00-overview.md` | `02-spec/02-coding-guidelines/00-overview.md` | `../02-coding-guidelines/00-overview.md` |
| `02-spec/09-gsearch-cli/01-backend/01-arch.md` | `02-spec/09-gsearch-cli/00-overview.md` | `../00-overview.md` |
...
4. **Master index** — `02-spec/00-overview.md` module table
