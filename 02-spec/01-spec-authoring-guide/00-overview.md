...
| 07 | [07-memory-folder-guide.md](./07-memory-folder-guide.md) | Guide | Structure and conventions for the `.ai-memory/memories/` tree |
...
| Execution plans and batch tracking | `.ai-memory/plan.md` |
...
| "Add this to the plan" | `.ai-memory/plan.md` |
...
3. Root `02-spec/` has `00-overview.md` and `99-consistency-report.md` (plus `folder-structure-root.md` as a redirect)
