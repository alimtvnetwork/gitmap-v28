...
| Item                | Location                                         |
|---------------------|--------------------------------------------------|
| Schema spec (this)  | `02-spec/01-spec-authoring-guide/17-version-schema.md` |
...
(`02-spec/17-consolidated-guidelines/04-enum-standards.md`).
...
- [CI/CD Issue 06 — Version Drift](../../.ai-memory/resolved-issues/06-version-drift-after-package-bump.md)
