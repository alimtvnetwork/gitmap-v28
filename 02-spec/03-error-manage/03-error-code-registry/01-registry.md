...
| `MWS` | Main/Worker Service (Worker tier) | 21000-21099 | `02-spec/19-main-worker-service/13-error-codes.md` | ✅ Active |
| `MWS` | Main/Worker Service (Main tier) | 21100-21199 | `02-spec/19-main-worker-service/13-error-codes.md` | ✅ Active |
...
- PS: `02-spec/11-powershell-integration/04-error-codes.md`
...
| Nexus Flow | `NF` | 8000-8399 | 8050-8069 | `02-spec/12-nexus-flow-cli/01-backend/04-error-codes.md` |
...
> See `02-spec/11-powershell-integration/04-error-codes.md` for full list.
