...
- [02-spec/03-error-manage/02-error-architecture/05-response-envelope/04-response-envelope-reference.md](./04-response-envelope-reference.md) — Canonical specification
- [02-spec/response-envelope/changelog.md](./02-changelog.md) — Migration timeline
- [02-spec/response-envelope/envelope.schema.json](./envelope.schema.json) — JSON Schema (Draft 2020-12) source of truth
- [02-spec/response-envelope/configurability.md](./01-adr.md) — Debug toggle rules
