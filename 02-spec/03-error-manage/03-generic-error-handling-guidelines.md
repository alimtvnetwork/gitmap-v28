...
> **Canonical Mirror:** [centralized-error-handling-architecture.md](../../.ai-memory/coding-guidelines.mdcentralized-error-handling-architecture.md)

Please refer to the root architectural specification at [`.ai-memory/coding-guidelines.mdcentralized-error-handling-architecture.md`](../../.ai-memory/coding-guidelines.mdcentralized-error-handling-architecture.md).
