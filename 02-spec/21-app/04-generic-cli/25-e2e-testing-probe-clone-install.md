...
> - [../88-clone-direct-url.md](../88-clone-direct-url.md) — direct-URL clone behavior
> - [../95-installer-script-find-latest-repo.md](../95-installer-script-find-latest-repo.md) — sibling-version probe rationale
> - [../103-probe-depth.md](../103-probe-depth.md) — probe internals
...
`02-spec/01-app/88-clone-direct-url.md`).
...
contract in [`02-spec/07-generic-release/09-generic-install-script-behavior.md`](../07-generic-release/09-generic-install-script-behavior.md).
