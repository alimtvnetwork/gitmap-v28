...
> - App reference: [02-spec/03-general/02d-deploy-patterns.md](../03-general/02d-deploy-patterns.md) — gitmap-v28 nested deploy pattern that motivates this generic spec
> - Issue references: [02-spec/02-app-issues/22-installer-path-not-active-after-install.md](../22-app-issues/22-installer-path-not-active-after-install.md)
