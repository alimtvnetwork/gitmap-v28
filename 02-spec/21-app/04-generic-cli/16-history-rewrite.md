...
> `02-spec/15-research/git-history-rewrite-remove-and-pin-file.md`.
...
4. **Verification** — re-run the canonical verification one-liner
   from `02-spec/15-research/.../§3` against the rewritten sandbox. Hard
...
- Research note: `02-spec/15-research/git-history-rewrite-remove-and-pin-file.md`
