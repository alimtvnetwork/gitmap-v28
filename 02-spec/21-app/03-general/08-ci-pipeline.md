...
amd64/arm64) for both `gitmap-v28` and `cli-updater`. Generates
...
- [02-spec/pipeline/README.md](../09-pipeline/README.md) — Index and quick reference
- [02-spec/pipeline/01-ci-pipeline.md](../09-pipeline/01-ci-pipeline.md) — CI patterns (SHA dedup, test matrix, builds)
- [02-spec/pipeline/02-release-pipeline.md](../09-pipeline/02-release-pipeline.md) — Release automation (versioning, install scripts)
- [02-spec/pipeline/03-vulnerability-scanning.md](../09-pipeline/03-vulnerability-scanning.md) — Vulnerability scanning
