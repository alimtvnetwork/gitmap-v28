...
>
> For CI-pipeline issues (lint, test, build matrix), see [`02-spec/12-cicd-pipeline-workflows/10-release-pipeline-issues-rca.md`](../12-cicd-pipeline-workflows/10-release-pipeline-issues-rca.md).
...
- `.github/workflows/release.yml`
- `02-spec/16-generic-release/04-checksums-verification.md`
...
- [02-spec/12-cicd-pipeline-workflows/10-release-pipeline-issues-rca.md](../12-cicd-pipeline-workflows/10-release-pipeline-issues-rca.md) — CI-pipeline issue catalog
...
- [02-spec/14-update/11-windows-icon-embedding.md](../14-update/11-windows-icon-embedding.md) — winres icon post-mortem
- [02-spec/17-consolidated-guidelines/15-cicd-pipeline-workflows.md](../17-consolidated-guidelines/15-cicd-pipeline-workflows.md) — Consolidated CI/CD guidelines
