...
| `02-spec/11-powershell-integration` | 1 | 1 | 0 | 0 | 90.0 / 100 | 🟡 Acceptable |
...
| V-934 | `02-spec/11-powershell-integration/templates/run.ps1` | 1 | `-` | `CG-SIZE-001` | 856 lines (hard cap: 300 lines) | Critical | Decompose monolithic file into focused domain modules |
...
| V-984 | `src/data/changelog.ts` | 846 | `-` | `CG-CASE-001` | `"New spec `02-spec/01-app/109-install-gitmap-oneliner` | Minor | Change uppercase abbreviation to PascalCase (Id, Url, Api) |
