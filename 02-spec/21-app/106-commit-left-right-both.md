...
**Related:** `24-amend-author.md` (commit metadata rewriting), `61-refactor-autocommit.md` (auto-commit primitives), `129-pr-commit-engines-and-sqlite-split-db.md` (PR commit engines, auto-merge & split-DB)
