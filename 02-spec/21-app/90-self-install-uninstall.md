...
- [02-spec/04-generic-cli/21-post-install-shell-activation/04-idempotency.md](./04-generic-cli/21-post-install-shell-activation/04-idempotency.md)
  — Marker block conventions used by `stripMarkerBlock`.
- [02-spec/01-app/89-update-path-sync.md](89-update-path-sync.md) — Sister
