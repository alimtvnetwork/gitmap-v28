...
- Manifest-mode clones (`json` / `csv` / `text`) ignore `--ssh` /
  ...
  `02-spec/01-app/110-clone-ssh-flag.md` (this file) as a follow-up.

## Related

- `02-spec/01-app/96-clone-replace-existing-folder.md` — replace-on-clone flow
- `02-spec/01-app/104-clone-multi.md` — multi-URL batch form
