...
- `02-spec/01-app/94-install-script.md` — internals of `install.ps1` / `install.sh`.
- `02-spec/07-generic-release/03-install-scripts.md` — release-side packaging.
- `02-spec/07-generic-release/09-generic-install-script-behavior.md` — version-resolution contract.
- `02-spec/01-app/90-self-install-uninstall.md` — `self-install` / `self-uninstall` semantics.
...
| Uninstall         | `irm https://raw.githubusercontent.com/alimtvnetwork/gitmap-v28/main/uninstall-quick.ps1 \| iex`                                                | `curl -fsSL https://raw.githubusercontent.com/alimtvnetwork/gitmap-v28/main/uninstall-quick.sh \| bash`                                     |
| Doctor / verify   | `gitmap doctor`                                                                                                                                | `gitmap doctor`                                                                                                                            |

The pinned commands assume the contract from
`02-spec/07-generic-release/09-generic-install-script-behavior.md`: with
...
- Container images / Homebrew tap / Scoop bucket — tracked separately
  in `02-spec/07-generic-release/05-release-assets.md`.
- Network-restricted installs (offline tarball) — covered by the
  pinned-version snippet in
  `02-spec/07-generic-release/08-pinned-version-install-snippet.md`.
