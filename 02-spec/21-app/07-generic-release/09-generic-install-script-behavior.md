...
> [`../95-installer-script-find-latest-repo.md`](../95-installer-script-find-latest-repo.md).
...
binary (see [`02-spec/08-generic-update/`](../08-generic-update/)), package-
...
7. On any failure (HTTP 404, checksum mismatch, missing asset), **MUST**
   ...
   ```
     ...
     See 02-spec/07-generic-release/09-generic-install-script-behavior.md §3.
   ```
