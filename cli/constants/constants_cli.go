...
const (
	...
	CmdCreate               = "create"
	CmdCreateAlias          = "crt"
	CmdRepoCreate           = "repo-create"
	CmdRepoCreateAlias      = "repoc"
	CmdCreateRepo           = "create-repo"
	CmdCreateRepoAlias      = "crepo"
	CmdCreateLocalRepo      = "create-local-repo"
	CmdCreateLocalRepoAlias = "clr"
	CmdCreateRepoLocal      = "create-repo-local"
	CmdRepoCreateLocal      = "repo-create-local"
	...
	CmdLowercaseReadme      = "lowercase-readme"
	CmdReadmeLower          = "readme-lower"
	...
	CmdLlm                 = "llm"
	CmdFind                = "find"
	CmdFindFiles           = "find-files"
	CmdFindFilesAny        = "find-files-any"
	CmdFindFilesStartsWith = "find-files-startswith"
	CmdFindFilesEndsWith   = "find-files-endswith"
	CmdListFiles           = "list-files"
	CmdFindRegex           = "find-regex"
	CmdFindRead            = "find-read"
	CmdFindReadJson        = "find-read-json"
	CmdFindRegexRead       = "find-regex-read"
	CmdFindRegexReadJson   = "find-regex-read-json"
	CmdFindHelp            = "find-help"
	CmdSearchHelp          = "search-help"
	CmdRegexHelp           = "regex-help"
	CmdSearch              = "search"
	CmdReplaceRegex        = "replace-regex"
	CmdRepoSearch          = "repo-search"
	CmdRepoSearchAlias     = "rps"
	CmdRepoRegex           = "repo-regex"
	CmdRepoRegexAlias      = "rpr"
	CmdRepoSearchJson      = "repo-search-json"
	CmdRepoSearchJsonAlias = "rsj"
	CmdRepoSearchRegexJson = "repo-search-regex-json"
	CmdSearchReplaceAll    = "search-replace-all"
	...
	CmdSCCat                 = "servers-clients cat"              // gitmap:cmd top-level
	CmdSCWrite               = "servers-clients write"            // gitmap:cmd top-level
	CmdSCSetDefaultPath      = "servers-clients set-default-path" // gitmap:cmd top-level
	CmdSCSetPathAlias        = "servers-clients set-path-alias"   // gitmap:cmd top-level
	CmdSCUpdate              = "servers-clients update"           // gitmap:cmd top-level
	CmdSCUpdateAll           = "servers-clients update-all"       // gitmap:cmd top-level
	...
	// 02-spec/05-coding-guidelines/21-golden-fixture-regeneration.md.
	...
	// codes and config schema. Spec: 02-spec/04-generic-cli/27-fix-repo-command.md.
	CmdFixRepo      = "fix-repo"
	CmdFixRepoAlias = "fr"
	...
	// 02-spec/01-app/116-bulk-visibility-mapub-mapri.md §undo-redo.
	...
	// mirror-clone sandbox. Spec: 02-spec/04-generic-cli/16-history-rewrite.md.
	...
	// 02-spec/03-commit-in/. Both tokens resolve to the same handler;
	// short alias is `cin`.
	...
	// 02-spec/01-vscode-project-manager-sync/04-tag-resync.md.
...
const (
	...
	HelpCloneSync        = "  clone-sync (cs) <url> [urls]      Clone and immediately sync to Workspaces & Antigravity"
	...
	HelpListVersions     = "  list-versions (lv)  Show all release tags, highest first (" + ColorCyan + "--limit" + ColorReset + " N, " + ColorCyan + "--json" + ColorReset + ", " + ColorCyan + "--source" + ColorReset + ")"
...
const (
	...
	FlagDescScanMaxDepth = "Max directory levels to descend below scan root (0 = default 16, negative = unlimited)"
	DefaultScanMaxDepth  = 0
	// RescanSubtreeDefaultMaxDepth is the cap `gitmap rescan-subtree`
	// applies when the user does not pass an explicit --max-depth.
	RescanSubtreeDefaultMaxDepth = 32
