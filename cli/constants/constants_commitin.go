...
const (
	...
	CommitInDescFunctionIntel        = "Enable/disable AST function body diffing ('on' or 'off')"
	CommitInDescPR                   = "Create a pull request for the replayed commits (values: 'all', 'tags', 'release')"
...
const (
	...
	CommitInErrSourceClone       = "commit-in: source: clone failed: %w\n"
	CommitInErrSourceInit        = "commit-in: source: git init failed: %w\n"
	CommitInErrSourceMkdir       = "commit-in: source: mkdir failed: %w\n"
	CommitInErrInputClone        = "commit-in: input %q: clone failed: %w\n"
	CommitInErrInputOpen         = "commit-in: input %q: open failed: %w\n"
	CommitInErrInputMixedKeyword = "commit-in: keyword %q must appear alone"
	CommitInErrDbMigrate         = "commit-in: db: migration failed: %w\n"
	CommitInErrDbWrite           = "commit-in: db: write failed: %w\n"
	CommitInErrProfileMissing    = "commit-in: profile %q not found\n"
	CommitInErrProfileBadJson    = "commit-in: profile %q: invalid json: %w\n"
