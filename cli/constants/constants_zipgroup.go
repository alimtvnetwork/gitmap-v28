...
const (
	...
	ErrZGCreate      = "failed to create zip group: %w"
	ErrZGQuery       = "failed to query zip groups: %w"
	ErrZGDelete      = "failed to delete zip group: %w"
	ErrZGAddItem     = "failed to add item to zip group: %w"
