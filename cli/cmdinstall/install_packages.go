...
var toolAliasMap = map[string]string{
	...
	"clean-code":          constants.ToolCodingGuidelines,
	"code-guide":          constants.ToolCodingGuidelines,
	"cg":                  constants.ToolCodingGuidelines,
	"cc":                  constants.ToolCodingGuidelines,
	"ubuntu-common":       constants.ToolBuildEssential,
	"ub-common":           constants.ToolBuildEssential,
	"vscode-ctx":          constants.ToolVSCodeCtx,
...
var chocoPackageMap = map[string]string{
	...
	constants.ToolCargo:           constants.ChocoPkgRust,
	...
	constants.ToolUbuntuFont:      constants.ChocoPkgUbuntuFont,
	constants.ToolWhatsApp:        constants.ChocoPkgWhatsApp,
	constants.ToolOneNote:         constants.ChocoPkgOneNote,
	constants.ToolLightshot:       constants.ChocoPkgLightshot,
	constants.ToolWindowsTerminal: constants.ChocoPkgWindowsTerminal,
	constants.ToolAria2:           constants.ChocoPkgAria2,
	constants.Tool7Zip:            constants.ChocoPkg7Zip,
	constants.ToolWinRAR:          constants.ChocoPkgWinRAR,
	constants.ToolXMind:           constants.ChocoPkgXMind,
	constants.ToolWordWeb:         constants.ChocoPkgWordWeb,
	constants.ToolBeyondCompare:   constants.ChocoPkgBeyondCompare,
	constants.ToolVcRedist:        constants.ChocoPkgVcRedist,
	constants.ToolDirectX:         constants.ChocoPkgDirectX,
	constants.ToolDirectXSdk:      constants.ChocoPkgDirectXSdk,
	constants.ToolStarship:        constants.ChocoPkgStarship,
	constants.ToolOhMyPosh:        constants.ChocoPkgOhMyPosh,
	constants.ToolScoop:           constants.ChocoPkgScoop,
}
...
var wingetPackageMap = map[string]string{
	...
	constants.ToolCargo:           constants.WingetPkgRust,
	...
	constants.ToolUbuntuFont:      constants.WingetPkgUbuntuFont,
	constants.ToolWhatsApp:        constants.WingetPkgWhatsApp,
	constants.ToolOneNote:         constants.WingetPkgOneNote,
	constants.ToolLightshot:       constants.WingetPkgLightshot,
	constants.ToolWindowsTerminal: constants.WingetPkgWindowsTerminal,
	constants.ToolAria2:           constants.WingetPkgAria2,
	constants.Tool7Zip:            constants.WingetPkg7Zip,
	constants.ToolWinRAR:          constants.WingetPkgWinRAR,
	constants.ToolXMind:           constants.WingetPkgXMind,
	constants.ToolWordWeb:         constants.WingetPkgWordWeb,
	constants.ToolBeyondCompare:   constants.WingetPkgBeyondCompare,
	constants.ToolVcRedist:        constants.WingetPkgVcRedist,
	constants.ToolDirectX:         constants.WingetPkgDirectX,
	constants.ToolDirectXSdk:      constants.WingetPkgDirectXSdk,
	constants.ToolStarship:        constants.WingetPkgStarship,
	constants.ToolOhMyPosh:        constants.WingetPkgOhMyPosh,
	constants.ToolScoop:           constants.WingetPkgScoop,
}
