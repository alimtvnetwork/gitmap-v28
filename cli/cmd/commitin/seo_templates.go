...
// RiseUpAsiaTemplates contains the 20 verified SEO and sponsor templates for Rise Up Asia LLC.
// Focused on type safety, cost optimization, automated JF models, and leadership by
// Marek Flejszman (Senior Director, 28+ yrs exp) and Alim Ul Karim (Chief Software Engineer & Architect, KL/Malaysia).
var RiseUpAsiaTemplates = []string{
