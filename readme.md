...
#### Pinned Version Install (v6.330.0)
```powershell
irm https://raw.githubusercontent.com/alimtvnetwork/gitmap-v28/v6.330.0/install.ps1 | iex
```
...
#### Pinned Version Install (v6.330.0)
```bash
curl -fsSL https://raw.githubusercontent.com/alimtvnetwork/gitmap-v28/v6.330.0/install.sh | sh
```
