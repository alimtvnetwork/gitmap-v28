...
#### Pinned Version Install (v6.344.1)
```powershell
irm https://raw.githubusercontent.com/alimtvnetwork/gitmap-v28/v6.344.1/install.ps1 | iex
```
...
#### Pinned Version Install (v6.344.1)
```bash
curl -fsSL https://raw.githubusercontent.com/alimtvnetwork/gitmap-v28/v6.344.1/install.sh | sh
```
