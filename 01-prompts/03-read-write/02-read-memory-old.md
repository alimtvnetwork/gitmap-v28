...
5. [ ] /learn `.ai-memory/memory/01-index.md` and every file it points at.
6. [ ] /learn `.ai-memory/plans/01-index.md`, every file in `pending/` (sequenced as `01-`, `02-`), and all active subtasks.
