...
8. Memory persistence:
   - You are allowed to write to the `.ai-memory/` directory to enhance project memory after reading.
   - Write summaries of what you learned into `.ai-memory/memory/learned/01-<slug>.md` (or `.ai-memory/memory/01-<slug>.md`), including file counts, to maintain context.
   - Update `.ai-memory/what-to-read.md` based on your progress to guide future reading workflows.
   - Document any discovered bugs into `.ai-memory/issues/01-<slug>.md` or `.ai-memory/suggestions.md`.
