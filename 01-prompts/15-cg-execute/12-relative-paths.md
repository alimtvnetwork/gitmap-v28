...
- [App Error Docs](file:///absolute/path/to/spec/03-error-manage/01-index.md) — Why: Standards for returning results.
...
- [App Error Docs](spec/03-error-manage/01-index.md) — Why: Standards for returning results.
