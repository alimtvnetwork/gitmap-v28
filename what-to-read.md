...
### 📌 Pinned version (`v6.32.0`)

```powershell
# Windows · PowerShell
irm https://github.com/alimtvnetwork/gitmap-v28/releases/download/v6.32.0/release-version-v6.32.0.ps1 | iex
```

```bash
# macOS · Linux · Bash
curl -fsSL https://github.com/alimtvnetwork/gitmap-v28/releases/download/v6.32.0/release-version-v6.32.0.sh | bash
```

#### 🧭 Version matrix - `v6.32.0` install-script URLs

One-line installers and release assets for the pinned **v6.32.0** build across every supported platform. All URLs resolve to the exact release tag - no fallback, no discovery.

| Platform | Shell | Install-script URL | Release binary asset |
| --- | --- | --- | --- |
| **Windows** (amd64) | PowerShell | [`release-version-v6.32.0.ps1`](https://github.com/alimtvnetwork/gitmap-v28/releases/download/v6.32.0/release-version-v6.32.0.ps1) | [`gitmap-6.32.0-windows-amd64.zip`](https://github.com/alimtvnetwork/gitmap-v28/releases/download/v6.32.0/gitmap-6.32.0-windows-amd64.zip) |
| **macOS** (arm64) | Bash | [`release-version-v6.32.0.sh`](https://github.com/alimtvnetwork/gitmap-v28/releases/download/v6.32.0/release-version-v6.32.0.sh) | [`gitmap-6.32.0-darwin-arm64.tar.gz`](https://github.com/alimtvnetwork/gitmap-v28/releases/download/v6.32.0/gitmap-6.32.0-darwin-arm64.tar.gz) |
| **macOS** (amd64) | Bash | [`release-version-v6.32.0.sh`](https://github.com/alimtvnetwork/gitmap-v28/releases/download/v6.32.0/release-version-v6.32.0.sh) | [`gitmap-6.32.0-darwin-amd64.tar.gz`](https://github.com/alimtvnetwork/gitmap-v28/releases/download/v6.32.0/gitmap-6.32.0-darwin-amd64.tar.gz) |
| **Linux** (amd64) | Bash | [`release-version-v6.32.0.sh`](https://github.com/alimtvnetwork/gitmap-v28/releases/download/v6.32.0/release-version-v6.32.0.sh) | [`gitmap-6.32.0-linux-amd64.tar.gz`](https://github.com/alimtvnetwork/gitmap-v28/releases/download/v6.32.0/gitmap-6.32.0-linux-amd64.tar.gz) |
| **Linux** (arm64) | Bash | [`release-version-v6.32.0.sh`](https://github.com/alimtvnetwork/gitmap-v28/releases/download/v6.32.0/release-version-v6.32.0.sh) | [`gitmap-6.32.0-linux-arm64.tar.gz`](https://github.com/alimtvnetwork/gitmap-v28/releases/download/v6.32.0/gitmap-6.32.0-linux-arm64.tar.gz) |

> **Release page:** [github.com/alimtvnetwork/gitmap-v28/releases/tag/v6.32.0](https://github.com/alimtvnetwork/gitmap-v28/releases/tag/v6.32.0) · **Asset naming contract:** `gitmap-<version>-<os>-<arch>.<ext>` (`.zip` on Windows, `.tar.gz` elsewhere) - verified by the installer pre-flight HEAD probe.
...
**GitMap** ([this repository](https://github.com/alimtvnetwork/gitmap-v28))
...
```powershell
Set-ExecutionPolicy Bypass -Scope Process -Force; [System.Net.ServicePointManager]::SecurityProtocol = [System.Net.ServicePointManager]::SecurityProtocol -bor 3072; iex ((New-Object System.Net.WebClient).DownloadString('https://raw.githubusercontent.com/alimtvnetwork/gitmap-v28/main/install.ps1'))
```
...
1. **Use `--allow-fallback`** — Automatically picks the newest patch in the same
   ...
   ```powershell
   irm https://github.com/alimtvnetwork/gitmap-v28/releases/download/v3.38.0/release-version-v3.38.0.ps1 | iex
...
| Script | URL Pattern |
|--------|-------------|
| Pinned PowerShell | `https://github.com/alimtvnetwork/gitmap-v28/releases/download/{version}/release-version-{version}.ps1` |
| Pinned Bash | `https://github.com/alimtvnetwork/gitmap-v28/releases/download/{version}/release-version-{version}.sh` |
...
```powershell
irm https://raw.githubusercontent.com/alimtvnetwork/gitmap-v28/main/install.ps1 | iex; Install-Gitmap -Version "v2.51.0"
```

**Specific version + custom directory (one-liner):**

```powershell
irm https://raw.githubusercontent.com/alimtvnetwork/gitmap-v28/main/install.ps1 | iex; Install-Gitmap -Version "v2.51.0" -InstallDir "D:\DevTools\gitmap"
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/alimtvnetwork/gitmap-v28/main/install.sh | sh -s -- --version v2.51.0
```
...
```bash
git clone https://github.com/alimtvnetwork/gitmap-v28.git gitmap
```
...
gitmap mv https://github.com/alimtvnetwork/gitmap-v28 \
...
- 🐛 **Fixes:** README badge now points at `goreportcard.com/badge/github.com/alimtvnetwork/gitmap-v28/gitmap` (real module path) instead of the repo root, which 404'd because there is no `go.mod` at the root.
...
- 💥 **Breaking:** `go.mod` module path renamed from a placeholder to `github.com/alimtvnetwork/gitmap-v28/gitmap`. Anyone importing the module by the old path must update their import lines. CLI users are unaffected.
...
[
  ...
  {
    "repoName": "gitmap-v28",
    "httpsUrl": "https://github.com/alimtvnetwork/gitmap-v28.git",
    "relativePath": "gitmap-v28",
    "depth": 1
  }
]
```
...
gitmap-v28,git@github.com:alimtvnetwork/gitmap-v28.git,,gitmap-v28
```
