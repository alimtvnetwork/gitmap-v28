...
const Sidebar = React.forwardRef<
  HTMLDivElement,
  React.ComponentProps<"div"> & {
    side?: SidebarSideType | undefined;
...
export enum SidebarMenuSubButtonSizeType {
  Sm = "sm",
  Md = "md",
}
  ...
  return (
    <Comp
      ...
      className={cn(
        ...
        size === SidebarMenuSubButtonSizeType.Sm && "text-xs",
        size === SidebarMenuSubButtonSizeType.Md && "text-sm",
        "group-data-[collapsible=icon]:hidden",
        className,
      )}
      {...props}
